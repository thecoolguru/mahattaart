...
<div class="product-details">
	<div class="row">
        ...
        <div class="col-sm-6">
		    <a style="color:#999;font-size:20px;" href="javascript:" <?php  if($this->session->userdata('userid')){?> data-toggle="modal" data-target="#login-modal4" onclick="addtogallery('<?=$image_id?>','<?=$image_filename?>')" <?php }else{?> data-toggle="modal" data-target="#myModal_registration" <?php }?> id="tgl" class="login-link2">
