<style>
#gal-customcombooptions{margin:0;border:0;width:230px;_width:230px;display:none;border:1px solid #8a9099;border-top:1px solid transparent;cursor:pointer;position:relative;top:4px;text-align:left;left:0;z-index:1}.gal-sortby{font-size:36px;color:#fff;height:24px;padding-bottom:11px;padding-left:22px}#gal-hovercombobox{height:28px;width:200px;font-size:20px;padding:4px 23px 4px 10px;color:#000}.viwepr{padding:2px 0}.viwepr li{display:inline;padding:0 2px}.view_per_page>.link{padding:1px 4px}.ourpp{float:left;width:169px}.pagination li a{border:0;color:#666;padding:2px 10px}.pagination li:nth-child(1){font-weight:700}.viwepr{font-family:"Times New Roman",serif;font-size:13px}.viwepr li:nth-child(4){font-weight:700}.viwepr li:nth-child(1){font-family:"Times New Roman",serif;font-size:13px}.pagination li:last-child a{border-radius:4px;color:#333}.pagination li a{font-family:"Times New Roman",serif;font-size:13px}.sortours{width:676px;float:left}.main-title{cursor:pointer;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#333;font-size:13px;margin:9px 0 4px;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif}.Next{background:url(http://dev.wallsnart.com/uploaded_pdf/Gallery_ImageSprite.png) no-repeat -49px -26px;width:18px;height:18px;vertical-align:bottom;border:0}.pdc{color:#F44349!important;font-family:"Helvetica Neue","HelveticaNeue-Light","Helvetica Neue Light",Helvetica,Arial,"Lucida Grande",sans-serif;font-size:12px;padding:0 15px}.products a{font-size:11px;text-decoration:underline!important;color:#888;font-size:11px;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif}.producttype a{font-size:12px;color:#999}.lineth{text-decoration:line-through}.wrap-inner{height:150px}.wrap-inner img{max-width:100%;max-height:100%;margin:auto;display:block}.ourd li{float:left;padding:0 4px}.right{float:right;border-bottom:dotted 1px #ccc}.career-page h3{font-family:'BebasNeueRegular',Arial,Helvetica,sans-serif;font-size:27px;font-weight:400;color:#000;margin:5px 0}.career-page h4{font-size:14px;font-weight:700;color:#000;margin:5px 0}.faqquestion p{padding:0 0 2px!important}.faqquestion p strong{font-size:14px;font-weight:700;color:#000;margin:0 0 18px}.faq-content p{padding:0 0 18px!important}.career-page ul{margin:4px 13px}ul.a{list-style-position:inside}.ic-home{top:-2px!important}.pagination_2 p{padding:10px 0}
</style>
...
<li class="col-md-2 col-sm-2">
    ...
    <div class="wrap">
        <div class="wrap-inner">
            <img class="galImage" src="http://static.mahattaart.com/158/<?=$images->images_filename;?>" alt="<?php print substr($result->images_caption,0,10); ?>" title="<?=substr($result[0]->images_caption,0,10); ?>" border="0">
        </div>
        <div class="main-title">
            <?=substr($result[0]->images_caption,0,20); ?>
        </div>
        <?php
            if($user_id=='609' || $user_id=='669' || $user_id=='661') {
        ?>
        <div class="products" style="padding:0 0 3px 0">
            <a href="#" style="margin-left:2px"> <?=$result[0]->images_photographer; ?></a> <a style="margin-left:90px" href='javascript:call_remove_lightBox(<?=$images->image_id; ?>,<?=$lightbox_id; ?>,<?=$page_no; ?>)'>Remove</a>
        </div>
        <?php } ?>
