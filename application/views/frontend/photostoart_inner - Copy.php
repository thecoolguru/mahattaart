...
<!-- div for dynamic variable storage style='display:none'-->
    ...
    <div id='type' style="display:none1"></div>
    <input id='crop_src' style='display1:none'>
    <input id='data' style='display1:none'>
    <div id='click' style='display1:none'></div>
	<div id='vertical_width' style='display1:none'></div>
	<div id='horizonal_height' style='display1:none'></div>
<!-- end -->
<!-- pricing Details -->
