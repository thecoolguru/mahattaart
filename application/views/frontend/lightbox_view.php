...
<a href="<?php echo base_url('search/products/'.$images->images_filename.'/'.$images->image_id.'/'.$images->lightbox_id);?>"</a>
<input type="hidden" name="img_id" id="img_id<?php print $images_id; ?>" value="<?php print $images_id ?>" />
<div class="wrap">

<!---

<div class="wrap-inner"><img class="galImage" src="http://static.mahattaart.com/158/<?php $images->images_filename;?>" alt="<?php print substr($result->images_caption,0,10); ?>" title="<?php // substr($result[0]->images_caption,0,10); ?>" border="0"></div>

----->
<?php
$bridege_image_id=substr($images->images_filename,8,-4);
...
$src="http://images2.bridgemanart.com/cgi-bin/bridgemanImage.cgi/150.XIR.".$bride_id.".7055475/".$bridege_image_id.".JPG";
?>
<div class="wrap-inner"><img class="galImage" src="<?=$src?>" alt="<?php print substr($result->images_caption,0,10); ?>" title="<?=substr($result[0]->images_caption,0,10); ?>" border="0"></div>
