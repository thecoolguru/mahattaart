...
<div class="container">
	<div class="row">
    	...
    	<div class="top_slider_content">
            ...
            <div id="val"></div>
			<a target="_self" class=" btn button-slider-upload para" href="" onclick="dropzone_box(); return false;"></a>
...
<div class="container">
  <div class="row">
    <div class="col-xs-4 col-sm-4 col-md-4 text-center">
      ...
      <a target="_self" class="btn button-slider-upload category" onclick="dropzone_box()" id='canvas'>Canvas</a>
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 text-center">
      ...
      <a target="_self" class=" btn button-slider-upload category" onclick="dropzone_box()" id='framing'>Framing</a>
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 text-center">
      ...
      <a target="_self" class="btn button-slider-upload category" onclick="dropzone_box()" id='print_only'>Print Only</a>
