...
<form id="frame_section" name="frame_section" action="<?php echo base_url()?>index.php/frontend/frame_section" method="POST" enctype="multipart/form-data">
...
<?php
                ...
                {
                    ?>
<td><a href="<?php echo base_url();?>index.php/frontend/frame_detail/<?php echo $d1[$i]->frame_id;?>" class="help"><?php echo $price->framenmount_colour?></a></td>
<?}}?>
</tr>
</table>
...
<?php
                    ...
                    for($i=0;$i<$did;$i++){
                        ...
                        ?>
<td><a href="<?php echo base_url();?>index.php/frontend/frame_detail/<?php echo $d1[$i]->frame_id;?>"><?php echo $price->framenmount_colour?></a></td>
<?}?>
</tr>
</table>
...
<?php
                    ...
                    for($i=0;$i<$did;$i++){
                        ...
                        ?>
<td><a href="<?php echo base_url();?>index.php/frontend/frame_detail/<?php echo $coms[0];?>/<?php echo $price->framenmount_colour?>/"><?php echo $price->framenmount_colour?></a></td>
<?}?>
</tr>
</table>
