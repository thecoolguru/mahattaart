...
<div class="container">
		<div class="row">
        <div class="art-style col-md-12"><div class="pagination">
        	<span> <a href="<?=base_url()?>frontend/index">HOME</a> > <span> ABOUT MAHATTA  ART</span> </span>
        </div></div>
        
            <div class="aboute abuth1 aboute abuth1 col-md-12">
            ...
            <img src="<?php print base_url();?>assets/img/our-miss.jpg" class="width01 img-responsive">
            ...
            <div class="col-md-3 col-sm-5"> <img style="float:right;" src="<?php print base_url();?>assets/img/our-viss.jpg" class="width01 img-responsive"> </div>
            </div>
