	...
	<td><?php echo $print['sales_person'];?></td>
		  <td><?php echo $print['client_servicing'];?></td>
		   <td><?php echo $print['region'];?></td>
			 <td><?php if($status_printer=='0' ){ echo 'Pending with Printer'; }elseif($status_printer>0){ echo "Complete";}?></td>
			 <td>
<?php 
                         if($this->session->userdata('userid')=='shalini@wallsnart.com')
                               {
	...
	<td><?php echo $print['sales_person'];?></td>
		  <td><?php echo $print['client_servicing'];?></td>
		   <td><?php echo $print['region'];?></td>
			 <td><?php if($status_printer=='0' ){ echo 'Pending with Printer'; }elseif($status_printer>0){ echo "Complete";}?></td>
			 <td>
		  <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/view_orders_details/<?=$print['order_id'];?>');">View </a>   <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/printer?order_id=<?=$print['order_id'];?>');">/ Edit</a>
<td><?php echo $print['created_date'];?></td>
  ...
  <td><?php echo $print['company_name'];?></td>
	<td><?php echo $print['sales_person'];?></td>
		  <td><?php echo $print['client_servicing'];?></td>
		   <td><?php echo $print['region'];?></td>
			 <td><?php if($status_printer=='0' ){ echo 'Pending with framer'; }elseif($status_printer>0){ echo "Complete";}?></td>
			 <td>
		  <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/view_orders_details/<?=$print['order_id'];?>');">View </a>  <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/edit_framer_order?order_id=<?=$print['order_id'];?>');">/Edit</a>
<td><?php echo $print['created_date'];?></td>
  ...
  <td><?php echo $print['company_name'];?></td>
	<td><?php echo $print['sales_person'];?></td>
		  <td><?php echo $print['client_servicing'];?></td>
		   <td><?php echo $print['region'];?></td>
			 <td><?php if($status_printer=='0' ){ echo 'Pending with Packager'; }elseif($status_printer>0){ echo "Complete";}?></td>
			 <td>
		 <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/view_orders_details/<?=$print['order_id'];?>');">View </a> <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/edit_packager_order?order_id=<?=$print['order_id'];?>');">/Edit</a>
<td><?php echo $print['created_date'];?></td>
  ...
  <td><?php echo $print['company_name'];?></td>
	<td><?php echo $print['sales_person'];?></td>
		  <td><?php echo $print['client_servicing'];?></td>
		   <td><?php echo $print['region'];?></td>
			 <td><?php if($status_printer=='0' ){ echo 'Pending with Courier'; }elseif($status_printer>0){ echo "Complete";}?></td>
			 <td>
		<a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/view_orders_details/<?=$print['order_id'];?>');">View </a> <a href="JavaScript:newPopup('<?=base_url()?>index.php/backend/edit_courier_order?order_id=<?=$print['order_id'];?>');">/Edit</a>
<td><?php echo $print['created_date'];?></td>
