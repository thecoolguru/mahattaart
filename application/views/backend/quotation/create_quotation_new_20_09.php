...
$(document).ready(function(){
 var counter = 1;
    $("#addButton_custom").click(function () {
        ...
        if(document.getElementById('old_image_custom').checked==true)
        {
          var status='1';
        }else if(document.getElementById('new_image_custom').checked==true){
            status='2';
        }
         change_div_custom(status);
         

        if(counter>10){    alert("Only 10 textboxes allow");     
            return false;	}   		
        var newTextBoxDiv = $(document.createElement('div')).attr("id", 'TextBoxDiv' + counter);
       newTextBoxDiv.after().html('<tr class="custom_class"><td><select name="category_custom[]" style="width: 86px;height: 28px;"  onchange="validate_print_type_more(this.value,'+counter+')" id="category_custom'+counter+'" data-id="'+counter+'"  ><option value="">-Print Type-</option><option value="1">Print</option><option value="2">Print+Mount</option><option value="3">Print + frame</option><option value="4">Print+frame+Mount+Glass</option><option value="5">Print+frame+Mount</option><option value="6">Print+frame+Canvas</option></select></td><td style="width:119px;"><div class="old_class_custom"><input type="text"  name="imgid_custom[]" data-id="'+counter+'"  class="txtbox_f_custom txtbox2" id="imgid_custom'+counter+'" /></div><div class="new_class_custom" id="new_image_custom" class="new_custom"><input type="file"  name="file_custom[]"  data-id="'+counter+'" class="file_custom"   id="file_custom'+counter+'" style="width:100px;" /></div></td><td class="order_id"><input type="text" placeholder="Order Id" name="order_id_custom[]" id="order_id_custom'+counter+'" class="txtbox2" ></td><td ><input type="text" placeholder="package Charge" name="packaging_charge_custom[]" data-id="'+counter+'" id="packaging_charge_custom'+counter+'" class="txtbox2" ></td><td ><input type="text" name="courier_charge_custom[]" data-id="'+counter+'" id="courier_charge_custom'+counter+'" placeholder="Courier Charge" class="txtbox2" ></td><td ><div class="image_preview_custom" id="image_preview_custom'+counter+'" ><img id="previewing_custom'+counter+'" src="" width="50" height="50"/></div><span id="image_visual_custom'+counter+'" class="image_visual_custom" style="height:80px; width: 80px; border: solid 1px; color:#CCCCCC "></span></td><td><span id="license_cost_custom_display'+counter+'">0.00</span><br><input type="text" class="txtbox2" name="license_cost_custom[]" id="license_cost_custom'+counter+'" placeholder="Licence Cost"    /></td><td><input type="text" placeholder="Surface" name="surface_custom[]" id="surface_custom" class="txtbox2"></td><td><input type="text" name="print_height_custom[]" id="print_height_custom'+counter+'" placeholder="P.Height"   class="txtbox2"></td><td ><input type="text" placeholder="P.Width" name="print_width_custom[]" id="print_width_custom'+counter+'" class="txtbox2"  ></td><td><input type="tex" readonly=""   name="print_rate_custom[]"  id="print_rate_custom'+counter+'" class="txtbox2" ></td><td class="printer"><input type="tex"  name="print_cost_custom[]" data-id="'+counter+'"   id="print_cost_custom'+counter+'" class="print_cost_custom" ></td><td class="printer"><input type="tex"  name="print_discount_custom[]" id="print_discount_custom'+counter+'" class="txtbox2" ></td><td><input type="tex" placeholder="Border"  name="border_custom[]" id="border_custom'+counter+'" class="txtbox2" ></td><td class="mount'+counter+'"><input type="text" placeholder="Mount" name="mount_code_custom[]" id="mount_code'+counter+'" class="txtbox2"></td><td></td><td  class="mount'+counter+'"><input type="text" placeholder="M.Width" name="mount_width_custom[]"   class="txtbox2" id="mount_width_custom'+counter+'"></td><td  class="mount'+counter+'"><input type="tex" readonly="" name="mount_rate_custom[]" id="mount_rate_custom'+counter+'" class="txtbox2" ></td><td  class="mount'+counter+'"><input type="tex"  name="mount_cost_custom[]" data-id="'+counter+'" id="mount_cost_custom'+counter+'"   class="mount_cost_custom" ></td><td  class="mount'+counter+'"><input type="tex"  name="mount_discount_custom" id="mount_discount_custom'+counter+'" class="txtbox2" ></td><td class="frame'+counter+'"><input type="text" placeholder="Frame" name="frame_code_custom[]" id="framer_code_custom'+counter+'"  class="txtbox2"></td><td></td><td class="frame'+counter+'"><input type="text" placeholder="F.Width" name="frame_width_custom[]" id="frame_width_custom'+counter+'" class="txtbox2"  ></td><td class="frame'+counter+'"><input type="tex"  name="frame_rate_custom[]" id="frame_rate_custom'+counter+'" class="txtbox2" ></td><td  class="frame'+counter+'"><input type="tex"  name="frame_cost_custom[]"   data-id="'+counter+'" id="frame_cost_custom'+counter+'" class="frame_cost_custom" ></td><td  class="frame'+counter+'"><input type="tex"  name="frame_discount_custom[]" id="frame_discount_custom'+counter+'" class="txtbox2" ></td><td class="canvas'+counter+'"><input type="tex"  readonly="" name="canvas_rate_custom[]" id="canvas_rate_custom'+counter+'" class="txtbox2" ></td><td class="canvas'+counter+'"><input type="tex"  name="canvas_cost_custom[]" data-id="'+counter+'" id="canvas_cost_custom'+counter+'"   class="txtbox2" ></td><td class="canvas'+counter+'"><input type="tex"  name="canvas_discount_custom[]" id="canvas_discount_custom'+counter+'" class="txtbox2" ></td><td  class="cover'+counter+'"><input type="text" placeholder="Glass" name="cover_custom[]" id="cover_custom'+counter+'"  class="txtbox2"></td><td  class="cover'+counter+'"><input type="tex" readonly="" name="glass_rate_custom[]" id="glass_rate_custom'+counter+'" class="txtbox2" ></td><td  class="cover'+counter+'"><input type="tex"  name="glass_cost_custom" data-id="'+counter+'" id="glass_cost_custom'+counter+'"   class="glass_cost_custom" ></td><td  class="cover'+counter+'"><input type="tex"  name="glass_discount_custom[]" id="glass_discount_custom'+counter+'" class="txtbox2" ></td><td class="cp"><span id="discount_custom'+counter+'"></span><br><input type="tex"  name="cp_amount[]" placeholder="CP Amount" id="cp_amount'+counter+'" data-id="'+counter+'" class="cp_amount" ></td><td><input type="text" readonly="" style="background-color:#F7F7F7; text-align: center; font: bold; border: none;" name="Q_total_custom[]" data-id="'+counter+'" id="total_custom'+counter+'"></td></tr>');
	newTextBoxDiv.appendTo("#TextBoxesGroup_custom");
		counter++;           });
		 ...
		 counter--;
		 var packaging_charge=30*counter;$('#packaging_charge_custom').val(packaging_charge);                $("#TextBoxDiv_custom" + counter).remove();		     });		     $("#getButtonValue_custom").click(function () {			var msg = '';	for(i=1; i<counter; i++){   	  msg += "\n Textbox #" + i + " : " + $('#textbox' + i).val();	}    	  alert(msg);     });  });
 ...
 function increase_values_custom()  {
  ...
  var value=document.getElementById('channel_partner').value;
     ...
     $('.c_list').hide();
        ...
        var packaging_charge=30*clicks;$('#packaging_charge_custom').val(packaging_charge);
        if(clicks>2){    $('#courier_charge_custom').val(0);}else{  $('#courier_charge_custom').val(50);  }
        clicks++;
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="creat-ordertable">
          ...
          <tr  class="darktr">
            ...
            <tr>
                ...
                <input type="radio" name="qutatiion"  onClick="return change_form_status('3');" value="3">
              </td>
                                  </tr>
			...
			<tr style="border-bottom:none" id="custom_form" >
                                    <td colspan="2" >
              <div class="customer-list" id="btn_foucs"><a href="#!" class="addnewcp" id='addButton_custom' onClick="return increase_values_custom();">Add New Item</a> <a href="#!" class="subtractwcp"  id='removeButton_custom'>Remove Item</a></div>
                                    <br>
                                    <div>Live Image
                <input type="radio" checked="" onClick="return change_div_custom('1');" name="radio" id="old_image_custom" >
                &nbsp;Upload Image
                <input type="radio"  onclick="return change_div_custom('2');" name="radio" id="new_image_custom" >
 &nbsp; Channel Partner <input type="checkbox" name="channel_partner" value="1" onClick="return show_channel_partner_custom();" id="channel_partner_custom" data-id="1">
            ...
            <td >Visual</td>
                        <td>License Cost(%)</td>
                        <td colspan="7" id="print_id">Print</td>
                        <td colspan="5" class="mount">Mount</td>
                        <td colspan="5" class="frame" id="canvas_id">Frame</td>
			<td colspan="3" class="canvas" >Canvas</td>
                        <td colspan="4" class="cover">Glass</td>
			<td class="cp"><strong>CP Amount</strong></td>
		        ...
		        <td>&nbsp;</td>
						...
						<td class="printer">Discount</td>
                        <td>Border</td>
                        <td class="mount">Name</td>
                        <td class="mount">Width</td>
                        <td class="mount">Rate</td>
						<td class="mount">Mount Cost</td>
						<td class="mount">Discount</td>
                        <td class="frame"> Name</td>
                        <td class="frame">Width</td>
                        <td class="frame" >Rate</td>
						 <td class="frame" >Frame Cost</td>
						  <td class="frame" >Discount</td>
                         <td class="canvas">Rate</td>
						 <td class="canvas">Canvas Cost</td>
						 <td class="canvas">Discount</td>
                        <td class="cover">Glass</td>
                        <td class="cover">Rate</td>
						<td class="cover">Glass Cost</td>
						<td class="cover">Discount</td>
		<td class="cp"></span></td>
                    ...
                    <tr class="custom_class">
                        <td><select data-id="0" name="category_custom[]" id="category_custom0" style="width: 86px;height: 28px;" onChange="validate_print_type(this.value)" >
  ...
  <td><div class="old_custom">
      <input type="text" class="txtbox2" name="imgid_custom[]" id="imgid0"  onBlur="return show_image_visual_custom(this.value);" />
    </div>
    <div class="new_custom"  id="filediv_custom">
      <input type="file"   name="file_custom[]" style="width:100px;"  id="file_custom" />
    </div></td>
  <td class="order_id"><input type="text" name="order_id_custom[]" id="order_id_custom0" class="txtbox2" ></td>
  <td ><input type="text" data-id="0" name="packaging_charge_custom[]" id="packaging_charge_custom0" class="txtbox2" ></td>
  <td ><input type="text" data-id="0" name="courier_charge_custom[]" id="courier_charge_custom0" class="txtbox2" ></td>
  <td ><div id="image_preview_custom" class="image_preview_custom"><img id="previewing_custom" src="" width="50" height="50"/></div>
    <span id="image_visual_custom" class="image_visual_custom" ></span></td>
  <td><span id="license_cost_custom_display0">0.00</span><br>
    <input type="text" class="txtbox2" name="license_cost_custom[]"   id="license_cost_custom0"  class="txtbox2"/></td>
  <td><input type="text" name="surface_custom[]" id="surface_custom0"  class="txtbox2" /></td>
  <td><input type="text" name="print_height_custom[]" id="print_height_custom0"   class="txtbox2" ></td>
  <td><input type="text" name="print_width_custom[]" id="print_width_custom0"   class="txtbox2"></td>
  <td><input type="tex" readonly=""  name="print_rate_custom[]"   id="print_rate_custom0"  class="txtbox2" ></td>
  <td class="printer"><input type="tex"  data-id="0" name="print_cost_custom[]" id="print_cost_custom0"   class="print_cost_custom" ></td>
  <td class="printer"><input type="tex"  name="print_discount_custom[]" id="print_discount_custom0" class="txtbox2" ></td>
  <td><input type="tex"  name="border_custom[]"   id="border_custom0" class="txtbox2" ></td>
  <td class="mount"><input type="text" name="mount_code_custom[]" class="txtbox2" id="mount_code0">
  </td>
  <td class="mount"><input type="text" name="mount_width_custom[]" id="mount_width_custom0"   class="txtbox2"></td>
  <td class="mount"><input type="tex" readonly="" name="mount_rate_custom[]" id="mount_rate_custom0" class="txtbox2" ></td>
  <td class="mount"><input type="tex"  data-id="0" name="mount_cost_custom[]"   id="mount_cost_custom0" class="mount_cost_custom" ></td>
  <td class="mount"><input type="tex"  name="mount_discount_custom[]" id="mount_discount_custom0" class="txtbox2" ></td>
  <td class="frame " ><input type="text" name="frame_code_custom[]"  class="txtbox2" id="framer_code_custom0">
  </td>
  <td class="frame"><input type="text" name="frame_width_custom[]" id="frame_width_custom0"  class="txtbox2">
  </td>
  <td class="frame "><input type="tex" readonly="" name="frame_rate_custom[]" id="frame_rate_custom0" class="txtbox2" ></td>
  <td class="frame "><input type="tex" data-id="0"    name="frame_cost_custom[]" id="frame_cost_custom0" class="frame_cost_custom" ></td>
  <td class="frame "><input type="tex" 
						 name="frame_discount_custom[]" id="frame_discount_custom0" class="txtbox2" ></td>
  <td class="canvas"><input type="tex" readonly="" name="canvas_rate_custom[]" id="canvas_rate_custom0" class="txtbox2" ></td>
  <td class="canvas"><input type="tex"    data-id="0" name="canvas_cost_custom[]" id="canvas_cost_custom0" class="canvas_cost_custom" ></td>
  <td class="canvas"><input type="tex"  name="canvas_discount_custom[]" id="canvas_discount_custom0" class="txtbox2" ></td>
  <td class="cover"><input type="text" name="cover_custom[]" id="cover_custom0" class="txtbox2">
  </td>
  <td class="cover"><input type="tex" readonly="" name="glass_rate_custom[]" id="glass_rate_custom0" class="txtbox2" ></td>
  <td class="cover"><input type="tex"  name="glass_cost_custom[]"  data-id="0"  id="glass_cost_custom0" class="glass_cost_custom" ></td>
  <td class="cover"><input type="tex"  data-id="0"  name="glass_discount_custom[]" id="glass_discount_custom0" class="txtbox2" ></td>
 
  <td class="cp"><span id="discount_custom0"></span><br>
    <input type="tex"  name="cp_amount[]" id="cp_amount0" data-id="0"  class="cp_amount" ></td>
                                    ...
                                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <td class="bold">WNA Final Amount: (Rs.)</td>
                                        <td class="total-price"><div >
                                            ...
                                            <input type="text"  style="color:#000000"  onkeyup="return reverse_calculate();"  name="finalTotal_txt_cp" id="finalTotal_txt_custom_cp" value="">
                                          </div></td>
                                      </tr>
...
<script>
     ...
     function change_div_custom(status){

                    if(status=='1')
                    {

		  $('.txtbox_f_custom').show();
                      $('.td_class_custom').show();
                         $('.old_custom').show();
                            $('.image_visual_custom').show();
                              $('.new_custom').hide();
                                $('.image_preview_custom').hide();

                    $('.new_class_custom').hide();
                     $('.old_class_custom').show();
                     $('.td_class_custom').show();
                     }else if(status=='2')
                    {
                     $('.txtbox_f_custom').hide();
                   $('.td_class_custom').hide();
                         $('.old_custom').hide();
                            $('.image_visual_custom').hide();
                              $('.new_custom').show();
                    $('.new_class_custom').show();
                   
                      $('.old_class_custom').hide();
                        $('.image_preview_custom').show();
...
<script type="text/javascript">         function save_item_quotation()
					...
					function show_image_visual_custom(image_id)
                          {
                              ...
                              success:function(response)
                              {
                                  ...
                                  a.height = 80;
                                  a.width = 80;
                                  $('#image_visual_custom').html(a);
                              }
                          });
                      }
                      $(document).ready(function(){
                          $(document).on("blur", ".txtbox_f_custom", function () {
                              var myBookId = $(this).data('id');
                              var image_id=  document.getElementById('imgid_custom'+myBookId).value;
                              $.ajax({
                                  type:'post',
                                  url:'show_images_viusal',
                                  data:'image_id='+image_id,
                                  success:function(response)
                                  {
                                      ...
                                      a.height = 80;
                                      a.width = 80;
                                      $('#image_visual_custom'+myBookId).html(a);
                                  }
                              });
                          });
                      });
...
$(document).ready(function (e) {
                ...
                $(function() {
                    $("#file_custom").change(function() {
                    $("#message_custom").empty();
                    var file = this.files[0];
                    var imagefile = file.type;
                    var match= ["image/jpeg","image/png","image/jpg"];
                    if(!((imagefile==match[0]) || (imagefile==match[1]) || (imagefile==match[2])))
                    {
                        $('#previewing_custom').attr('src','noimage.png');
              ...
              function imageIsLoaded(e) {
                  $("#file_custom").css("color","#FFFFFF");
                  $('#image_preview_custom').css("display", "block");
                  $('#previewing_custom').attr('src', e.target.result);
                  $('#previewing_custom').attr('width', '80px');
                  $('#previewing_custom').attr('height', '80px');
              };
          });
           ...
           $(document).ready(function (e) {
              ...
              function imageIsLoaded(e) {
                  ...
                  $('#previewing_offline'+myBookId).attr('height', '80px');
                            ...
                            $(document).ready(function(){
                          $(document).on("blur", ".file_custom", function () {
                              var myBookId = $(this).data('id');
...
$(document).ready(function(){
     $('#online_form').show();
		...
		$('#custom_form').hide();
                 document.getElementById("print_id").colSpan='7';
  ...
  function validate_print_type(print_id)
     ...
     if(print_id=='1'){
        $('.mount').hide();
            ...
            document.getElementById("canvas_id").colSpan='5';
     }else if(print_id=='2'){
        $('.mount').show();
            $('.frame').hide();
            $('.cover').hide();
...
function show_channel_partner_custom_more(value){
...
function show_channel_partner_custom(){
        var value=document.getElementById('channel_partner_custom').value;

         if(value=='1'){
             $('.order_id').show();
             $('.Channel_p').show();
               $('#final_amount').hide();
             $('#channel_partner_custom').val(2);
              $('.cp').show();
         }else if(value=='2'){
             $('#channel_partner_custom').val(1);
              $('.order_id').hide();
                $('#final_amount').show();
                  $('.cp').hide();
              $('.Channel_p').hide();
...
$('#discount_custom_amt'+id).html(cp_discount_amt_fix);
   ...
   var licence_cost=print_cost_custom*license_cost_custom/100;
    var multply=parseFloat(print_height_custom)*parseFloat(print_width_custom);
    var print_rate=  parseFloat(print_cost_custom)/multply;
    //alert(license_cost_custom);
    var total=parseFloat(packaging_charge_custom)+parseFloat(courier_charge_custom)+parseFloat(print_cost_custom);
    $('#license_cost_custom_display'+id).html(licence_cost);
    
     if(!isNaN(print_rate)){
      $('#total_custom'+id).val(total.toFixed(2));
       $('#print_rate_custom'+id).val(print_rate.toFixed(2));
   }
 ...
 $('.mount_cost_custom').keyup(function(){
    ...
    var print_cost_custom=$('#print_cost_custom'+id).val();
    var multply=parseFloat(print_height_custom)*parseFloat(mount_width_custom);
    var mount_rate=  parseFloat(mount_cost_custom)/multply;
   
        var total=parseFloat(packaging_charge_custom)+parseFloat(courier_charge_custom)+parseFloat(print_cost_custom)+parseFloat(mount_cost_custom);
        
   if(!isNaN(mount_rate)){
      $('#total_custom'+id).val(total.toFixed(2));
       $('#mount_rate_custom'+id).val(mount_rate.toFixed(2));
   }
  ...
  $('.frame_cost_custom').keyup(function(){
   ...
   var print_height_custom=$('#print_height_custom'+id).val();
    ...
    var courier_charge_custom=$('#courier_charge_custom'+id).val();
    var print_cost_custom=$('#print_cost_custom'+id).val();
    var multply=parseFloat(print_height_custom)*parseFloat(frame_width_custom);
    var frame_rate=  parseFloat(frame_cost_custom)/multply;
   
        var total=parseFloat(packaging_charge_custom)+parseFloat(courier_charge_custom)+parseFloat(print_cost_custom)+parseFloat(frame_cost_custom);
      
        
        if(!isNaN(frame_rate)){
       $('#total_custom'+id).val(total.toFixed(2));
       $('#frame_rate_custom'+id).val(frame_rate.toFixed(2));
   }
    
   });   
   
   
   $('.glass_cost_custom').keyup(function(){
    var id=$(this).data('id');
   var print_height_custom=$('#print_height_custom'+id).val();
    var cover_custom=$('#cover_custom'+id).val();
    var glass_cost_custom=$('#glass_cost_custom'+id).val();
   var frame_cost_custom=$('#frame_cost_custom'+id).val();
    var packaging_charge_custom=$('#packaging_charge_custom'+id).val();
    var courier_charge_custom=$('#courier_charge_custom'+id).val();
    var print_cost_custom=$('#print_cost_custom'+id).val();
   var mount_cost_custom=$('#mount_cost_custom'+id).val();
    var multply=parseFloat(print_height_custom)*parseFloat(cover_custom);
    var glass_rate=  parseFloat(glass_cost_custom)/multply;
    
    
        var total=parseFloat(packaging_charge_custom)+parseFloat(courier_charge_custom)+parseFloat(print_cost_custom)+parseFloat(frame_cost_custom)+parseFloat(mount_cost_custom)+parseFloat(glass_cost_custom);
   ...
   var print_height_custom=$('#print_height_custom'+id).val();
    ...
    var print_cost_custom=$('#print_cost_custom'+id).val();
    var multply=parseFloat(print_height_custom)*parseFloat(print_width_custom);
    var canvas_rate=  parseFloat(canvas_cost_custom)/multply;
  
        var total=parseFloat(packaging_charge_custom)+parseFloat(courier_charge_custom)+parseFloat(print_cost_custom)+parseFloat(frame_cost_custom)+parseFloat(canvas_cost_custom);
...
$('#finalTotal_txt_custom_cp').val(final_total);
        }
...
.glass_cost_custom{width: 81px; height: 30px;}
