...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="creat-ordertable">
  ...
  <tr class="darktr">
    ...
    <td><input type="file" data-id="0"   name="file_custom[]"  value="<?php  echo $qtn_tbl->print_size_height;?>" class="file_upload" id="file_custom0" />
    </td>
    <td class="bold">Collection Name:</td>
    <td><input type="text"   value="<?php  echo $qtn_tbl->collection;?>" name="collection_name[]" class="txtbox2" id="collection_name0"/>
    </td>
    <td class="bold">Packaging Charge</td>
    <td><input type="text" data-id="0" class="txtbox2" value="<?php  echo $qtn_tbl->packing_charge;?>" name="packaging_charge_custom[]" id="packaging_charge_custom0">
    </td>
  </tr>
  <tr>
    ...
    <td><input type="text" data-id="0" value="<?php  echo $qtn_tbl->surface;?>" class="txtbox2" name="surface_custom[]" id="surface_custom0" /></td>
  </tr>
  <tr class="darktr">
    <td class="bold">Border</td>
    <td><input type="tex"  class="txtbox2" value="<?php  echo $qtn_tbl->border;?>" name="border_custom[]"   id="border_custom0">
    </td>
    ...
    <td class="order_id0"><input type="text" value="<?php  echo $qtn_tbl->order_id;?>" name="order_id_custom[]" class="txtbox2" id="order_id_custom0"></td>
  ...
  <tr class="darktr">
    ...
    <td width="218" class="printer"><input type="tex"  value="<?php  echo $final_roya;?>" name="final_royality[]" id="final_royality0" class="txtbox2" ></td>
    <td width="82" class="bold printer"> Final WNA license share</td>
    <td width="434" class="printer"><input type="tex"   value="<?php  echo $final_roya;?>" name="final_wna_license_share[]" id="final_wna_license_share0" class="txtbox2" ></td>
  ...
  <tr class="darktr">
    ...
    <td><input type="text" data-id="0" value="<?php  echo $qtn_tbl->print_size_height;?>"  name="print_height_custom[]" id="print_height_custom0"   class="printer" >
    </td>
    <td class="bold">Width:</td>
    <td><input type="text" data-id="0" value="<?php  echo $qtn_tbl->print_size_width;?>" name="print_width_custom[]" id="print_width_custom0"   class="printer">
    </td>
	 <td class="bold">Minimum Rate:</td>
    <td><input type="tex" data-id="0" name="print_rate_custom[]" value="<?php  echo $qtn_tbl->print_total;?>"   id="print_rate_custom0"  class="printer" ></td>
    
  </tr>
  <tr>
   <td class="bold">Print Cost</td>
    <td class="printer">
      <input type="tex"  data-id="0" value="<?php  echo $qtn_tbl->print_cost;?>" name="print_cost_custom[]" id="print_cost_custom0"   class="print_cost_custom printer" ></td>
    <td class="bold">Discount </td>
    <td class="printer"><input type="tex" data-id="0" value="<?php  echo $qtn_tbl->print_discount;?>" name="print_discount_custom[]" id="print_discount_custom0" class="printer" ></td>
    <td class="bold">Actual Print Cost</td>
    <td ><input type="text" name="actual_print_cost[]" value="<?php  echo $qtn_tbl->actual_print_cost;?>" id="actual_print_cost0" class="txtbox2"></td>
  </tr>
  
  <tr>
   <td class="bold">Actual Rate</td>
    <td class="printer">
      <input type="tex"  data-id="0" value="<?php  echo $qtn_tbl->print_rate;?>" name="actual_rate[]" id="actual_rate0"  readonly=""  class="print_cost_custom printer" ></td>
    <td class="bold"> </td>
    <td class="printer"></td>
    <td class="bold"></td>
    <td ></td>
  ...
  <tr class="darktr mount0">
    ...
    <td class="mount0"><input type="text" value="<?php  echo $qtn_tbl->mount_id;?>" name="mount_code_custom[]" class="txtbox2" id="mount_code0">
    </td>
    <td class="bold mount0"> Mount Width </td>
    <td class="mount0"><input type="text" data-id="0" value="<?php  echo $qtn_tbl->mount_size_width;?>" name="mount_width_custom[]" id="mount_width_custom0"   class="mount_cost_custom"></td>
    <td class="bold mount0">Discount : </td>
    <td class="mount0"><input type="tex"  readonly="" value="<?php  echo $qtn_tbl->mount_discount;?>" name="mount_discount_custom[]" id="mount_discount_custom0" class="txtbox2" ></td>
  </tr>
  <tr class="mount0">
    <td class="bold mount0">Charge Rate:</td>
    <td class="mount0"><input type="text" readonly="" value="<?php  echo $qtn_tbl->mount_rate;?>" name="mount_rate_custom[]" id="mount_rate_custom0" class="txtbox2" ></td>
	 <td class="bold mount0">Actual Cost </td>
         <td class="mount0"><input type="text" readonly="" value="<?php  echo $qtn_tbl->mount_actual_cost;?>" data-id="0" name="mount_actual_cost_custom[]"   id="mount_actual_cost_custom0" class="txtbox2" ></td>
    <td class="bold mount0">Cost </td>
    <td class="mount0"><input type="text"  data-id="0" value="<?php  echo $qtn_tbl->mount_cost;?>" name="mount_cost_custom[]"   id="mount_cost_custom0" class="mount_cost_custom" ></td>
  </tr>
  ...
  <tr class="darktr frame0">
    ...
    <td class="frame0" ><input type="text" name="frame_code_custom[]" value="<?php  echo $qtn_tbl->frame_id;?>" class="txtbox2" id="framer_code_custom0">
    </td>
    <td class="bold frame0"> Frame Width </td>
    <td class="frame0"><input type="text" name="frame_width_custom[]" value="<?php  echo $qtn_tbl->frame_size_width;?>" data-id="0" id="frame_width_custom0"  class="frame_cost_custom">
    </td>
    <td class="bold frame0">Discount : </td>
    <td class="frame0 "><input type="text" readonly="" value="<?php  echo $qtn_tbl->frame_discount;?>" name="frame_discount_custom[]" id="frame_discount_custom0" class="txtbox2" ></td>
  </tr>
  <tr class="frame0">
    <td class="bold frame0"><span class="bold mount">Charge</span>  Rate:</td>
    <td class="frame0"><input type="text" readonly="" value="<?php  echo $qtn_tbl->frame_total;?>" name="frame_rate_custom[]" id="frame_rate_custom0" class="txtbox2" ></td>
	
	<td class="bold ">Actual Cost </td>
        <td ><input type="text"  readonly="" data-id="0" name="frame_actual_cost_custom[]" value="<?php  echo $qtn_tbl->frame_actual_cost;?>"  id="frame_actual_cost_custom0" class="txtbox2" ></td>
    <td class="bold frame0">Cost </td>
    <td class="frame0"><input type="tex" data-id="0"  value="<?php  echo $qtn_tbl->frame_cost;?>"  name="frame_cost_custom[]" id="frame_cost_custom0" class="frame_cost_custom" ></td>
  </tr>
  ...
  <tr class="canvas0">
    ...
    <td class="canvas0"><input type="text" data-id="0" value="canvas" name="canvas_custom[]" id="canvas_custom0" class="canvas_cost_custom">
    <td class="bold canvas0">Actual Cost </td>
    <td class="canvas0"><input type="text"  readonly="" value="<?php  echo $qtn_tbl->actual_canvas_cost;?>" name="canvas_actual_cost_custom[]" id="canvas_actual_cost_custom0" class="txtbox2" ></td>
    
	<td class="bold canvas0"> Cost </td>
    <td class="canvas0"><input type="text"  data-id="0" value="<?php  echo $qtn_tbl->canvas_cost;?>" name="canvas_cost_custom[]" id="canvas_cost_custom0" class="canvas_cost_custom" ></td>
   
  </tr>
  <tr class="canvas0">
   
    <td class="bold canvas0"><span class="bold ">Charge Rate</span> </td>
    <td class="canvas0"><input type="text" name="canvas_rate_custom[]" value="<?php  echo $qtn_tbl->canvas_rate;?>" readonly="" id="canvas_rate_custom0" class="txtbox2">
    <td class="bold canvas0">Discount : </td>
    <td class="canvas0"><input type="text" name="canvas_discount_custom[]" value="<?php  echo $qtn_tbl->canvas_discount;?>" id="canvas_discount_custom0" data-id="0" class="canvas_cost_custom" ></td>
  </tr>
  ...
  <tr class="cover0">
    ...
    <td class="cover0"><input type="text" data-id="0" value="<?php  echo $qtn_tbl->glass_name;?>" name="cover_custom[]" id="cover_custom0" class="cover_cost_custom">
    <td class="bold cover0">Actual Cost </td>
    <td class="cover0"><input type="text"  readonly="" value="<?php  echo $qtn_tbl->actual_glass_cost;?>" data-id="0" name="cover_actaul_cost_custom[]" id="cover_actaul_cost_custom0" class="txtbox2" ></td>
	<td class="bold cover0"> Cost </td>
    <td class="cover0"><input type="text"  value="<?php  echo $qtn_tbl->glass_cost;?>" data-id="0" name="cover_cost_custom[]" id="cover_cost_custom0" class="cover_cost_custom" ></td>
	 
  </tr>
  <tr class="cover0">
   
    <td class="bold cover0"><span class="bold mount">Charge</span> Rate</td>
    <td class="cover0"><input type="text" readonly="" value="<?php  echo $qtn_tbl->glass_rate;?>" name="glass_rate_custom[]" id="glass_rate_custom0" class="txtbox2"></td>
	<td class="bold covers0">Discount:</td>
    <td class="cover0"><input type="tex"  value="<?php  echo $qtn_tbl->glass_discount;?>" name="cover_discount_custom[]" id="cover_discount_custom0" class="txtbox2" ></td>
  </tr>
  ...
  <tr >
    ...
    <td class="order_id0"><input type="text"  value="<?php  echo $qtn_tbl->cp_amount;?>" name="cp_amount[]" id="cp_amount_custom0" data-id="0"  class="cp_amount" ></td>
	
	<td class="bold order_id0">Seller's Commision&nbsp;<input type="text" value="<?php  echo $qtn_tbl->sp_amount;?>"  name="sp_amount[]" id="sp_amount_custom0" data-id="0"  class="sp_amount" ></td>
    <td class="order_id0">&nbsp;Seller's Amount&nbsp;<input type="text"   value="<?php  echo $qtn_tbl->seller_amount;?>" name="seller_amount[]" id="seller_amount0" data-id="0"  class="sp_amount" ><br>
	<span id="different_amount0">0.00</span>
	</td>
	<td width="190" class="bold">WNA SP Price</td>
    <td ><input type="text"  style="background-color:#F7F7F7; text-align: center; font: bold; border: none;" name="Q_total_custom[]" id="total_custom0" data-id="0" value="<?php  echo $qtn_tbl->wna_sp_amount;?>" class="txtbox2"></td>
...
-->
                                      ...
                                      <td class="bold">Total CP Amount: (Rs.)</td>
                                        ...
                                        <td class="total-price"><div >
                                            ...
                                            <input type="text"   style="background-color:#08558d; font: bold; border: none;" name="finalTotal_txt" id="finalTotal_txt_custom_wna" value="<?php  echo $qtn_tbl->wna_sp_amount;?>">
                                          </div></td>
                                      </tr>
              </table>
			  <?php 
...
$(document).on('click','.c_list',function(){
 ...
 var name=$(this).data('name');
	...
	var id=$(this).data('id');
	//alert(id);
	var vall =$("#category_custom0 option:selected").val();
//alert(vall);
...
$('#total_cp_amount').val(indian_money_format(final_cp_total));
 ...
 //started by sajid for cp amount revers
	...
	$('#total_custom'+id).keyup(function(){
...
//alert(commision);
 ...
 if(!isNaN(commision)){
    $('#sp_amount_custom'+id).val(commision.toFixed(2)); 
	//alert(tax_amount);
 }
 if(!isNaN(total_custom)){
    $('#finalTotal_txt_custom_wna').val(Q_total_custom_val); 
	$('#seller_amount'+id).val(fiiffordiscount.toFixed(2)); 
	// $('#different_amount').val(Q_total_custom_val.toFixed(2));
	$('#different_amount'+id).html(Q_total_custom_val.toFixed(2));
