<?php $customer=$this->customer_model->get_frontnback_customer();?>
...
<script type="text/javascript">
    function get_email(customer)
    {
        ...
        $.ajax({
            ...
            type: "POST",
            url: "<?=base_url();?>index.php/customer/customer_emails",
            data: datastring,
...
<div id="middle-wrapper">
    <div id="middle-container">  <span style="color:red;"> <?= $msg;?> </span>
        <div class="main-hdr"> Send Quotation</div>
        <form id="send_mail_customer" action="<?=base_url()?>index.php/quotation/send_mails_quotation" method="post">
            <div class="send-mail">
                        ...
                        <td  class="totd"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="175"><select name="cp-names" id="cp-names" class="inputs" onchange="get_email(this.value);">
                                            ...
                                            <?php
                                            $customer=$this->customer_model->get_customers_email();
                                            foreach($customer as $cust_name){?>
