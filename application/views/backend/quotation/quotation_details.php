...
<div class="invoice-heading">
<p> QUOTATION NO. <?=$quotation_details[0]->quotation_id?>] </p>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="invoice-order">
    ...
    <tr>
      ...
      <td width="22%"><p align="center"><strong>Order Details</strong></p></td>
...
//print_r($mount_details);
      ...
      $product_width=$details->print_size_width+$details->mount_size_width+$details->frame_size_width;//($details->frame_size_width);
         ...
         $glass_rate= $rate_details['glass_rate'];
          ...
          if($details->print_type==1){
              $wna_sp_amount=$details->wna_sp_amount;
              $price=$details->price;
    ...
    <tr>
	  ...
	  echo '<b>Order Id:</b> '.$details->order_id.'<br>';
	   echo '<b>SKU ID:</b> '.strtoupper($fileName);?><br /><br />
...
<br>
     ...
     <b>Courier Charge:</b>   
      ...
      <td width="8%"><p><?='1';?></p></td>
      <td width="12%"><p>&#x20B9;.<?php echo number_format((float)$details->wna_sp_amount, 2, '.', '')?></p></td>
<!--      <td width="7%" nowrap="nowrap" valign="moddle"><p><?='5';?></p></td>
	...
	<?php  $i++; endforeach;
       ...
       $after_discount=$cp_total-$total_discount;
         $after_tax=$after_discount*100/105;
        ?>
...
<tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;">WNA SP Amount&nbsp; &#x20B9; <?php  echo  number_format((float)$total_wna_sp_amount, 2, '.', '')?>/-</p></td>
    </tr>

     
<!--<tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;">Tax Amount&nbsp; &#x20B9; <?php  echo  number_format((float)$after_tax, 2, '.', '')?>/-</p></td>
    </tr>

<tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;">Tax <?php echo '5';?>&nbsp; &#x20B9; <?php  echo  number_format((float)$tax, 2, '.', '')?>/-</p></td>
    </tr>


    <tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;">After Discount&nbsp; &#x20B9; <?php  echo  number_format((float)$after_discount, 2, '.', '')?>/-</p></td>
    </tr>
   <tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;">Discount&nbsp; &#x20B9; <?php  echo  number_format((float)$total_discount, 2, '.', '')?>/-</p></td>
    </tr>-->
    <tr>
        <td nowrap="nowrap" colspan="8" valign="bottom"><p align="right" style="font:bold;"><strong>Final Payable Amount&nbsp; &#x20B9; <?php  echo number_format((float)$total_wna_sp_amount, 2, '.', '')?>/-</strong></p></td>
    </tr>
  </table>
