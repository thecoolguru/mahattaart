  <?php
  //print_r($framer_edit_id);
  $frame_code= $this->uri->slash_segment(3);
  $edit= $this->uri->slash_segment(4);
//echo $_REQUEST['id'];
...
<div id="middle-wrapper">
  ...
  <div id="middle-container">
    ...
    if($msg<>'')
    {
        ?><script>setTimeout(function(){timeOut();},2000); function timeOut(){window.location.href="edit_framer/<?=$framer_code?>/<?=$framer_edit_id[0]?>"}</script><?php
    }
    print $msg;?>
        </span>
		  ...
		  <input type="hidden" name="framer_edit_id" value="<?=$edit_id[0];?>">
