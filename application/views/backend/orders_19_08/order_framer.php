...
?>
  ...
  <?php endforeach;?>
    ...
    <tr class="darktr"> <td ></td><td>OnLine<input checked type="radio" data-id="1" name="type" id="online" class="type" value="1"> &nbsp;Off Line  <input type="radio" data-id="2"  id="offline" name="type" class="type" value="2"> </td><td></td><td></td></tr>
...
<tr  class="offline">
    ...
    <tr  class="online">
                ...
                <tr class="ofline" id="framer_td"><td class="darktr offline"> Framer</td><td> <input type="text" name="display_name" id="printer2" class="offline txtClass"></td></tr>
                ...
                <tr >
                  ...
                  <td width="250">
                      <input type="text" placeholder="Framer Name" name="frame_name" onkeyup="short_framer_rate(this.value);" id="frame_name2" class="offline txtClass">
                 ...
                 <td width="120" class="bold">
                     <input type="text" placeholder="MGB Name" name="mgb_name" id="mgb_name2" onkeyup="display_mgb_txt(this.value);" class="offline txtClass">
                     ...
                     <input type="text" placeholder="Mount Name" name="mount_name" id="mount_name2" onkeyup="display_mount_txt(this.value);" class="offline txtClass">
                    ...
                    <td width="120" class="bold" >
                        <input type="text" placeholder="Glass Name" name="glass_name" id="glasses_name2" onkeyup="display_glass_txt(this.value);" class="offline txtClass">
                ...
                <td width="250">
                <input type="text" placeholder="Rate" name="rate" id="rate2" class="offline txtClass">
                <select  name="rate" id="rate" class="online" >
                  ...
                  Height
                  &nbsp;
                  <input type="text"  name="height" placeholder="Frame Height" id="height" class="txtClass">
                  </td>
                  ...
                  <input type="text"  name="width" placeholder="Frame Width" id="width" class="txtClass">
                  </td>
                  ...
                  Height
                  &nbsp;
                  <input type="text"  placeholder="Mount Height" name="m_height" id="m_height" class="txtClass">
                  </td>
                  ...
                  <input type="text" placeholder="Mount Width"  name="m_width" id="m_width" class="txtClass">
                  </td>
                  ...
                  Height
                  &nbsp;
                  <input type="text"  placeholder="Glass Height" name="g_height" id="g_height" class="txtClass">
                  </td>
                  ...
                  <input type="text" placeholder="Glass Width"  name="g_width" id="g_width" class="txtClass">
                  </td>
                  ...
                  Height
                  &nbsp;
                  <input type="text"  placeholder="MGB Height" name="mgb_height" id="mgb_height" class="txtClass">
                  </td>
                  ...
                  <input type="text" placeholder="MGB Width"  name="mgb_width" id="mgb_width" class="txtClass">
                  </td>
                  ...
                  &nbsp;
                  &nbsp;
                  <input type="text" class="txtClass"  name="total_print" id="total_print">
                  </td>
                ...
                <?=date('Y-m-d h:t');?>
                  ...
                  <td>
                  <select name="quality_check" id="quality_check" class="inputs">
                ...
                <td class="bold">QC done by</td>
                  <td><input id="quality_checker_name" type="text" name="quality_checker_name" /></td>
                </tr>
                <tr>
                  <td class="bold">Person Incharge</td>
                  <td><input type="text" id="person_incharge" name="person_incharge" >
                  </td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
        ...
        <div style="padding:30px; ">
            <input type="button" name="addcpn" id="addcpn" value="Update" class="bt-add" onclick="return save_framer_details();" />
