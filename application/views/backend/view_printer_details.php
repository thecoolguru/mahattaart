...
<div class="main-hdr"> View Printer Orders</div>
...
<div class="viewcplist-inner">
    <table width="100%" border="0" id="printer_details" class="display" cellspacing="0" cellpadding="0">
        ...
        <tr class="hdrs">
          ...
          while($data = mysql_fetch_object($printer_code)){
               $result=$this->backend_model->Get__printer_details($data->printer_code);
                $result->contact_person_name
              ?>
         <tbody>
          <tr>
          <td><?=$data->printer_code;?></td>
          ...
          <td><a href="<?=base_url()?>index.php/backend/edit_printer/<?php echo  $data->printer_code?>">Edit Details</a></td>
          </tr>
         </tbody>
          <?php }?>
      </table>
...
var url="<?=base_url()?>index.php/backend/view_printer_details?vender_name="+vender_name;   
...
var url="<?=base_url()?>index.php/backend/view_printer_details?email_id="+email_id;   
window.location.href=url;
...
var url="<?=base_url()?>index.php/backend/view_printer_details?vender_code="+vender_code;   
window.location.href=url;
