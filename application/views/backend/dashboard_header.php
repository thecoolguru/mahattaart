...
<ul>
   <?php if($this->session->userdata('userid')!=''){
       ...
       ?>  
    <li class="loggedin"> Welcome "<?php if($this->session->userdata('userName')){ 
...
<li class="subtop"><a href="<?=base_url()?>index.php/backend/customer"> Manage Vendor</a>
<ul>
<li> <a href="<?=base_url()?>index.php/backend/add_vendor">Add</a></li>
 <li> <a href="<?=base_url()?>index.php/backend/view_vendor">View</a></li>
<li> <a href="<?=base_url()?>index.php/backend/vn_onlineoder">Online-Vendor Oders</a></li>
 <li> <a href="<?=base_url()?>index.php/backend/view_vendor_quotations">View-Vendor orders</a></li>
        <!--<li> <a href="<?=base_url()?>index.php/customer/send_mails_customers">Send Email</a></li>-->
</ul>
</li>	
