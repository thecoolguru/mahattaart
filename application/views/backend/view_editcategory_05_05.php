...
<form name=category action="<?=base_url()?>index.php/backend/view_editcategory/<?=$changes_id->id?>" method="post"  >
    ...
    <tr>
        ...
        <td><input type="submit" value="save" name="savecategory" class="bt-sbt-upload"  >&nbsp; <a href="<?=base_url()?>index.php/backend/manage_category"><input type="button" value="View All" name="savecategory" class="bt-sbt-upload"  ></a></td>
        </tr>
</table>
