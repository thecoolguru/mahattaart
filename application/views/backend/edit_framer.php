 ...
 function show_oldTextBox1<?=$i?>()
 {
   ...
   // var str_height= height.substring(0, 2).toUpperCase();
	...
	<div id="TextBoxDiv1">  
       ...
       <td id="td0"><div><input type="file"  name="file2[]" style="width:100px;"  id="file" />  </div></td>
          ...
          <br>
           ...
           {   ?>
            <table style="border-bottom: 0px;  width: 100%">
               ...
               <tr id="tr"> <td>Mount Name</td><td>Mount</td><td>Visual</td> <td>Unit</td><td>Rate</td><td>QTY</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td> <td>Code Generate</td><td>Description</td></tr>  
...
<input type="hidden" name="some_code[]" id="some_code" value="<?=$mount_code?>">
            ...
            <table style="border-bottom: 0px;  width: 100%">
                ...
                <tr id="tr"> <td>Mount Name</td><td>Mount</td><td>Visual</td><td>Unit</td> <td>Rate</td><td>QTY</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td><td>Code Generation</td><td>Description</td><td></td></tr>  
    
     <tr id="get_data">
       <td id="td2"><input type="text"name="framenamen[]" style="margin-right: -5px;" id="mgbname" class="inputbxs05" placeholder="Mount Name"/></td>
     <td id="td2"><div><input type="file"  name="file3[]" style="width:100px;"  id="file" />  </div></td>
       <td id="td2"><div id="image_preview" class="image_preview"><img id="previewing" src="" width="50" height="50"/></div></div></td>
...
<style>
    ...
    .inputbxs3{ width: 77px; height:29px;  }
     ...
     .inputbxs05{ width: 77px; height:29px;  }
  ...
  $(document).ready(function (e) {        
              ...
              function imageIsLoaded(e) {
                  ...
                  $('#previewing').attr('height', '80px');
                    ...
                    $("#file2"+myBookId).change(function() {
                    $("#message2"+myBookId).empty(); // To remove the previous error message
                    var file = this.files[0];
                    var imagefile = file.type;
                    //alert(imagefile);
                    var match= ["image/jpeg","image/png","image/jpg"];
                    if(!((imagefile==match[0]) || (imagefile==match[1]) || (imagefile==match[2])))
                    {
                        $('#previewing2'+myBookId).attr('src','noimage.png');
              ...
              function imageIsLoaded(e) {
                  $("#file2"+myBookId).css("color","#FFFFFF");
                  $('#image_preview2'+myBookId).css("display", "block");
                  $('#previewing2'+myBookId).attr('src', e.target.result);
                  $('#previewing2'+myBookId).attr('width', '80px');
                  $('#previewing2'+myBookId).attr('height', '80px');
              };
          });
           ...
           $(document).ready(function (e) {        
              ...
              function imageIsLoaded(e) {
                  ...
                  $('#previewing').attr('height', '80px');
                    ...
                    $("#file3"+myBookId).change(function() {
                    $("#message3"+myBookId).empty(); // To remove the previous error message
                    var file = this.files[0];
                    var imagefile = file.type;
                    //alert(imagefile);
                    var match= ["image/jpeg","image/png","image/jpg"];
                    if(!((imagefile==match[0]) || (imagefile==match[1]) || (imagefile==match[2])))
                    {
                        $('#previewing3'+myBookId).attr('src','noimage.png');
              ...
              function imageIsLoaded(e) {
                  $("#file3"+myBookId).css("color","#FFFFFF");
                  $('#image_preview3'+myBookId).css("display", "block");
                  $('#previewing3'+myBookId).attr('src', e.target.result);
                  $('#previewing3'+myBookId).attr('width', '80px');
                  $('#previewing3'+myBookId).attr('height', '80px');
              };
          });
