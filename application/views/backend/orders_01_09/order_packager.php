        ...
        <tr style="border-bottom:none">
          <td colspan="2" ><div class="viewcplist-inner">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <?php $i=1; foreach($order_details as $ord){                 $status_packager=$this->backend_model->status_packager($ord->order_id);                 $data_split= split('/',$ord->image_id);                    if($data_split[0]=='images')                    {                   $fileName=$data_split[2];                        $image_url=base_url().$ord->image_id;                    }else {                         $fileName=$ord->image_id;                        $image_url="http://www.indiapicture.in/wallsnart/398/".$ord->image_id."";                    }?>
                <tr>
                  <td><?=$i.'.';?></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr  style="background-color:<?=$classColor;?>">
                    <td class="bold" style="background-color:<?=$classColor;?>"><?=$i.'. '?>
                      Size of box use for packaging </td>
                    <td><select class="txtClass" name="size_box_packats[]" >
                  ...
                  <tr >
                    ...
                    <td><input <?php if($printer[0]->final_packets_height<>''){ echo 'readonly';}?> type="text" name="height[]" class="txtClass" value="<?=$printer[$index]->final_packets_height?>" placeholder="Height">
                    </td>
                    <td><input  placeholder="Width" type="text" name="width[]" value="<?=$printer[$index]->final_packets_width?>" class="txtClass">
                    </td>
                    <td><input <?php if($printer[0]->final_packets_depth<>''){ echo 'readonly';}?> type="text"  placeholder="Depth" name="depth[]"  value="<?=$printer[$index]->final_packets_depth?>" class="txtClass">
                    </td>
                  </tr>
                  <tr  class="darktr">
                    <td class="bold">Final product weight after packaging (in Kg)</td>
                    <td><input type="text" <?php if($printer[0]->final_packets_weight<>''){ echo 'readonly';}?> name="final_wight[]" value="<?=$printer[$index]->final_packets_weight?>" class="txtClass"></td>
                    <td></td>
                    <td></td>
                  </tr>
                  <?php $index++; $i++;}?>
                  <tr class="darktr">
                    ...
                    <td class="bold">Completion Date</td>
                    <td><input  <?php if($printer[0]->completion_date<>''){ echo 'readonly';}?>  type="date" value="<?=$printer[0]->completion_date?>"  name="completion_date"></td>
                  </tr>
                  <tr class="darktr">
                    <td class="bold">QC</td>
