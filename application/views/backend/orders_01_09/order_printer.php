  ...
  <option value="">---Select Printers---</option>
                    ...
                    <tr >
                        ...
                        <td width="250">
                            ...
                            <input  type="text" name="surface_off"  class="txtClass offline" readonly=""  value="<?=$order_details[0]->surface?>">
...
?>
                        ...
                        <td >Height&nbsp;<input type="text" readonly="" value="<?=$ord->print_size_height;?>"  name="height[]" id="height" class="txtClass"></td>



                        <td>Width&nbsp; <input type="text" readonly="" value="<?=$ord->print_size_width;?>"  name="width[]" id="width" class="txtClass"></td>
