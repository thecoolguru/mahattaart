          ...
          <td colspan="2" style="padding:0;"><div class="quotation-div"  id="quotation2Div" style="margin-left:25px">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <?php $index=0; $j=1; foreach($order_details as $ord){
				...
				$mount_split=split('x',$framer_order[$index]->mount_size);
                               
			  if($j%2==0){  $classColor='#FF9966';}else{    $classColor='#66CC00';}
			  ?>
              <tr style="background-color:<?=$classColor;?>">
                <td width="140" >Framer Name</td>
                <td width="345"><input  value="<?=$framer_order[$index]->framer;?>" type="text" placeholder="Framer Name"  name="frame_name[]"   class="txtClass">
                </td>
				<td width="258" ></td>
				<td width="258" ></td>
              </tr>
              <tr style="background-color:<?=$classColor;?>">
                ...
                <td width="345" > Height&nbsp;
                    <input value="<?=$mount_split[0];?>" type="text"  name="mount_height[]" class=" txtClass">
                </td>
                <td width="258" > Width&nbsp;
                  <input value="<?=$mount_split[1];?>" type="text"  name="mount_width[]"  class=" txtClass">
                </td>
				<td width="258" ></td>
              </tr>
              ...
              <tr style="background-color:<?=$classColor;?>">
                ...
                <td width="345" ><input value="<?=$ord->glass_name;?>" type="text"  name="glass_name[]" class=" txtClass">
                </td>
                <td width="258" ></td>
				<td width="258" ></td>
              </tr>
              <?php }?>
              <tr style="background-color:<?=$classColor;?>">
                <td width="140" >Frame Color</td>
                <td width="345" ><input value="<?=$framer_order[$index]->frame_color;?>" type="text"  name="frame_color[]" class=" txtClass">
                </td>
                <td width="258" >Mount Color&nbsp;</td>
                <td width="541" ><input value="<?=$framer_order[$index]->mount_color;?>" type="text"  name="mount_color[]" class=" txtClass"></td>
              </tr>
              <?php $j++;$index++; }?>
              <tr >
              ...
              <tr class="darktr">
                ...
                <td class="bold">Completion Date</td>
                <td><input <?php if($printer[0]->completion_date==''){?> type="date"<?php }?> value="<?=$printer[0]->completion_date?>" <?php if($printer[0]->completion_date<>''){ echo 'readonly';}?>  name="completion_date" id="completion_date"></td>
              </tr>
              <tr >
                <td class="bold">QC</td>
