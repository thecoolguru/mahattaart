...
<div class="main-hdr">View by Images Clicked to Enlarge</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mult-view-images-table">
  ...
  <tr>
    ...
    <td>xxxx</td>
    <td><img src="<?=base_url()?>assets/images/art2.jpg" width="106" height="74" alt="f" /></td>
  </tr>
  <tr>
    <td>xxxxxxxxxxxxx</td>
    <td>xxxxxxxx</td>
    <td>xxxxxxxxxx, xxxxxxxxxx, xxxxxxxxxxxxxx</td>
    <td>xxxx</td>
    <td><img src="<?=base_url()?>assets/images/art3.jpg" alt="" width="106" height="62" /></td>
  </tr>
  <tr>
    <td>xxxxxxxxxxxxx</td>
    <td>xxxxxxxx</td>
    <td>xxxxxxxxxx, xxxxxxxxxx, xxxxxxxxxxxxxx</td>
    <td>xxxx</td>
    <td><img src="<?=base_url()?>assets/images/art.jpg" alt="" width="107" height="107" /></td>
  </tr>
  <tr>
    <td>xxxxxxxxxxxxx</td>
    <td>xxxxxxxx</td>
    <td>xxxxxxxxxx, xxxxxxxxxx, xxxxxxxxxxxxxx</td>
    <td>xxxx</td>
    <td><img src="<?=base_url()?>assets/images/YJ9X000Z.jpg" alt="" width="90" height="115" /></td>
  </tr>
</table>
</div>
