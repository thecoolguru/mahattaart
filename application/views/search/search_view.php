                     ...
                     <div class="row">
                        <div class="ourpp col-md-12 col-sm-12 col-xs-12">
                           ...
                           <ul class="viwepr pull-right" style="margin-right:10px">
                              ...
                              <li class="link"> | </li>
                              <li class="link" <?php if($limit=='64'){?> style="color:#000 !important;font-size:16px;" <?php } ?>> <? echo '<a href="' . base_url() . 'search/'.$action.'/'.$prev.'/64/'.$search_text.'/'.$category_id.$shapes.$colors.'"> 64 </a>'; ?> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="gallery-img row">
                  ...
                  <article class="col-sm-3 col-md-3">
                      ...
                      <div class="thumbnail">
                          ...
                          <div class="ex-thumbnail-zoom-img" data-scale="2" data-image="<?=$img_src;  ?>">
                          </div>
                        </div>                        
                        </a>
                        <div class="caption">
