...
<ul class="viwepr">
<li>View Per Page</li>
<li class="link" <?php if($limit=='16'){?> style="color:#000 !important;font-size:16px;" <?php } ?>> <? echo '<a href="' . base_url() . 'index.php/search/'.$action.'/'.$prev.'/16/'.$search_text.'/'.$category_id.$shapes.$colors.'"> 16 </a>'; ?> </li>
<li class="link"> | </li>
<li class="link"  <?php if($limit=='32'){?> style="color:#000 !important; font-size:16px;" <?php } ?>> <? echo '<a href="' . base_url() . 'index.php/search/'.$action.'/'.$prev.'/32/'.$search_text.'/'.$category_id.$shapes.$colors.'"> 32 </a>'; ?> </li>
<li class="link"> | </li>
<li class="link" <?php if($limit=='64'){?> style="color:#000 !important;font-size:16px;" <?php } ?>> <? echo '<a href="' . base_url() . 'index.php/search/'.$action.'/'.$next.'/64/'.$search_text.'/'.$category_id.$shapes.$colors.'"> 64 </a>'; ?> </li></ul>
</div>
<div class="ourpp">
<div>

<ul class="pagination viwepr" style="padding:0; margin-right:-15px">
<li class="page-item Prev"> <? echo '<a class="page-link Prev"  aria-label="Prev" href="' . base_url() . 'index.php/search/'.$action.'/'.$prev.'/'.$limit.'/'.$search_text.'/'.$category_id.$shapes.$colors.'">'?> </a> </li>
<?php if($page!=1){?>
<li><? echo '<a href="' . base_url() . 'index.php/search/'.$action.'/'.$prev.'/'.$limit.'/'.$search_text.'/'.$category_id.$shapes.$colors.'"> '.$prev.' </a>'; ?></li>
<?php }?>
<li ><? echo '<a  href="' . base_url() . 'index.php/search/'.$action.'/'.$page.'/'.$limit.'/'.$search_text.'/'.$category_id.$shapes.$colors.'" style="color:#000; !important;font-size:16px;"><b > '.$page.'</b> </a>'; ?></li>
<li><? echo '<a href="' . base_url() . 'index.php/search/'.$action.'/'.$next.'/'.$limit.'/'.$search_text.'/'.$category_id.$shapes.$colors.'">'; ?><?=$next;?></a></li>
<li class="page-item Next"> <? echo '<a class="page-link Next"  aria-label="Next" href="' . base_url() . 'index.php/search/'.$action.'/'.$next.'/'.$limit.'/'.$search_text.'/'.$category_id.$shapes.$colors.'">'?> </a> </li>
</ul>
</div>
</div>
</div>
...
if($bride[0]=='BRID'){
 ...
 if($bride[0]=='BRID'){
 $img_src= "http://images2.bridgemanart.com/cgi-bin/bridgemanImage.cgi/150.XIR.".$bride_id.".7055475/".$data[1].".JPG";
	...
	$link='image_detail';
      ...
      ?>
<li>
<a href="<?=base_url()."index.php/search/".$link."/".$image_filename."/".$image_id."/".$image_collection_id;  ?>">
...
<div class="product-details">
		<a href="<?=base_url()."index.php/search/".$link."/".$image_filename."/".$image_id."/".$image_collection_id;  ?>" style="float:left"> 
