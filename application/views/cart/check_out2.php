		          ...
		          <div id="no-more-tables">
					...
					<tbody>
                        ...
                        foreach($data as $image){
                         if($cart_data[$k] == 0){
                          echo $source = "http://static.mahattaart.com/158/".$image['image_name'];    
                         }else{
                         $url = base_url();
                         echo $source = $url."application/views/frontend/upload_images/".$image['image_name'];
                         }
                         $k++;
                        ?>
            <tr>
                ...
                <table width="100%" cellpadding="10px;" cellspacing="0">
                    <tr>
                        <td>Payable Amount</td>
                            <td><img src="<?=base_url()?>assets/images/rupee-img-price.gif"/><?= $grand_total;?>
                            </td>
                    </tr>
