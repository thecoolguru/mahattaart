...
foreach ($search_data as $item){
 ...
 <div>  <a href="javascript:;" onclick="addtointrestedgallery('<?=$item['image_id']?>','<?=$images_id?>');"> <i class="glyphicon glyphicon-envelope"></i> </a>      
        
		
		
		<a style=" color:#999; font-size:20px; padding-left:68%"
								href="javascript:;" <?php  if($this->session->userdata('userid')){?> onclick="addtogallery(<?=$item['image_id']?>,<?=$images_id?>);" <?php }else{?> onclick="login('');" <?php }?> id="tgl" ><i class="gall"> </i> </a> Details to buy 
                                ...
                                <div class="frame-glasss">
                                <div class="col-md-6" style="padding:3px 4px 3px 0px; box-sizing: border-box;">
                                
                                <span> Primary:</span> <span>Name</span>
                                
                                <div>
  <input type="checkbox" name="vehicle" value="Frame1"> Frame1<br>
  <input type="checkbox" name="vehicle" value="Frame2" checked> Frame2<br>
  <input type="checkbox" name="vehicle" value="Fram3" checked> Frame3<br>
  </div>
                                 ...
                                 <div class="col-md-6" style="padding:3px 0px 3px 8px; box-sizing: border-box;">
                                 <span> Glass:</span> <span>Name</span>
  ...
  <input type="checkbox" name="vehicle" value="Fram3" checked> Frame3<br>
                        ...
                        <style>.frame-glasss{ font-size:12px;}</style>
...
<span class="pagination" style="padding:0px; margin:0px;">
  ...
  <li class="page-item"> <? echo '<a class="page-link Next"  aria-label="Next" href="' . base_url() . 'index.php/search/dosearch/'.$category_id.'/'.$next.'/'.$limit.'/'.$search_text.'/'.$sort_by.'/'.$filter_product_type.'/'.$filter_collection.'/'.$filter_medium.'/'.$size.'/'.$price_slab.'/'.$shape.'/'.$filterColor.'">'?> <!--<span aria-hidden="true" style="color:#666666;"> &raquo; </span>--> </a> </li>
</span>
</div>
</div>
</div>
