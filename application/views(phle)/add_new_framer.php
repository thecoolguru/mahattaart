...
<div id="middle-wrapper">
  <div id="middle-container">
	...
	<div id="TextBoxDiv1">  
         ...
         <tr id="tr"> <td>Frame Name</td> <td>Unit</td><td>Amount</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td><td>Quantity</td><td>Display Name </td> <td>Code Generation</td><td>Description</td></tr>  
    ...
    <td id="td0"><input type="text"name="cost[]" id="cost1" class="inputbxs1" placeholder="Amount"/></td>
        <td id="td0"><input type="text"name="height[]" onblur="return get_data_with_height(this);" id="height" class="inputbxs1" placeholder="Height"/></td>
    ...
    <td id="td0"><input type="text"name="color[]" onblur="return get_data_with_height(this);" id="color" class="inputbxs1" placeholder="Color"/></td>
     <td id="td0"><input type="text"name="Quantity[]"  id="box" class="inputbxs1" placeholder="Quantity"/></td>
          ...
          $mgb_name=  $this->backend_model->get_frame_code('mgb_name');
           ?> 
            ...
            <table style="border-bottom: 0px;  width: 95%">
                ...
                <tr id="tr"> <td>M+g+b Name</td> <td>Unit</td><td>Amount</td><td>Quantity</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td><td>Code Generation</td> <td>Description</td><td></td></tr>  
    ...
    <td id="td3"><input type="text"name="unit[]" id="unit1" class="inputbxs3" placeholder="Unit"/></td>
       <td id="td3"><input type="text"name="cost[]" id="cost1" class="inputbxs3" placeholder="Amount"/></td>
...
<input type="hidden" name="some_code[]" id="some_code" value="<?=$mount_code?>">
            ...
            <table style="border-bottom: 0px;  width: 95%">
                ...
                <tr id="tr"> <td>Mount Name</td><td>Unit</td> <td>Amount</td><td>QTY</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td><td>Code Generation</td><td>Description</td></tr>  
    ...
    <td id="td2"><input type="text"name="unit[]" id="unit3" class="inputbxs05" placeholder="Unit"/></td>
       <td id="td2"><input type="text"name="cost[]" id="cost3" class="inputbxs05" placeholder="Amount"/></td>
    ...
    <td><textarea name="desc[]" id="desc1" rows="4" cols="15" placeholder="Description" style="margin-left: 2px;"></textarea></td>
       <td></td> 
          ...
          <div class="customer-list" id="btn_foucs" ><a href="#!"class="addnewcp" id='addButton4' >Add Row</a> <a href="#!" class="subtractwcp" id='removeButton4'>Remove Row</a></div>
       <br>
          <div id='glassmount_groupdiv'>
	<div id="glassmount_div">  
          ...
          $glass_code=  $this->backend_model->get_frame_code('glass_name');
           ?> 
            ...
            <table style="border-bottom: 0px;  width: 95%">
                ...
                <tr id="tr"> <td>Glass Name</td> <td>Unit</td><td>Amount</td><td>QTY</td><td>Height</td><td>Width</td><td>Depth</td><td>Color</td><td>Code Generation</td> <td>Description</td><td></td></tr>  
...
<input type="hidden" name="some_code[]" value="<?=$hard_code?>">
            ...
            <table style="border-bottom: 0px;  width: 95%">
                ...
                <tr id="get_data">
       <td id="td2"><input type="text"name="framename[]" style="margin-right: -5px;" id="hardborad" class="inputbxs9" placeholder="Hard Borad"/></td>
    <td id="td2"><input type="text"name="unit[]" id="unit1" class="inputbxs9" placeholder="Unit"/></td>
    <td id="td2"><input type="text"name="cost[]" id="cost1" class="inputbxs9" placeholder="Amount"/></td>
    <td id="td2"><input type="text"name="Quantity[]" id="Quantity1" class="inputbxs9" placeholder="Quantity"/></td>
    <td id="td2"><input type="text"name="height[]" onblur="return get_data_with_height5(this);" id="height5" class="inputbxs9" placeholder="Height"/></td>
...
'<table style="border-top: 0px; border-bottom: 0px; width:100%;"><tr><td id="td2"><input hidden="text" name="some_code[]" value="<?=$frame_code?>"><input type="text"name="framename[]" id="framename'+counter+'" class="inputbxs2" style="margin-left: 0px;" placeholder="Frame Name"/></td> <td id="td2"><input type="text"name="unit[]" id="unit'+counter+'" class="inputbxs2" placeholder="Unit"/></td><td id="td2"><input type="text"name="cost[]" id="cost'+counter+'" class="inputbxs2" placeholder="Amount"/></td><td id="td2"><input data-toggle="modal"  data-id="'+counter+'" type="text"name="height[]" id="height'+counter+'" class="inputbxs2" placeholder="Height"/></td><td><input type="text"name="width[]" id="width'+counter+'" data-toggle="modal"  data-id="'+counter+'" class="inputbxs2" placeholder="Width"/></td><td id="td2"><input type="text"name="lenght[]" id="lenght'+counter+'" class="inputbxs2" placeholder="Depth"/></td><td id="td2"><input type="text"name="color[]"  data-toggle="modal"  data-id="'+counter+'" id="color'+counter+'" class="inputbxs2" placeholder="Color"/></td><td id="td2"><input type="text"name="Quantity[]" id="Quantity'+counter+'" class="inputbxs2" placeholder="Quantity"/></td><td id="text_box'+counter+'"><a  href="" id="new_textBox'+counter+'" class="newClass" style="margin-left:5px" data-toggle="modal" data-id="'+counter+'" data-action="new_list">New Display Name</a><a data-toggle="modal" data-id="'+counter+'" data-action="old_list" class="newClass" style="margin-left:25px; display:none; "  id="list_display_name'+counter+'" >Old Display Name</a><br><select name="display_name_list[]" id="display_name_list'+counter+'" class="inputbxs2" style="height: 29px; padding-left:0px;margin-left: 0px;width: 92px;"><option value="">---Select---</option><?php foreach($package_rows as $values){?><option  value="<?=$values->sur_code;?>"><?php echo $values->sur_code;?></option><?php }?></select></td><td id="td2"> <input name="frame_code[]" id="package_code_gen'+counter+'" style="    width: 73px; height: 29px; margin-top: 17px;"> </td><td id="td2"><textarea name="desc[]" id="desc'+counter+'" rows="4" cols="15" placeholder="Description" style="margin-right: 23px;"></textarea></td></tr></table>');
...
$('#list_display_name').hide();
 $('#new_display_name').show();
  ...
  var newTextBoxDiv = $(document.createElement('div'))
    ...
    newTextBoxDiv.after().html(
'<table style="border-top: 0px; border-bottom: 0px; width:100%;"><tr><td id="td4"><input hidden="text" name="some_code[]" value="<?=$mgb_name?>"><input type="text"name="framename[]" id="framename'+counter+'" class="inputbxs4" style="margin-left: 0px;" placeholder="M+g+b Name"/></td> <td id="td4"><input type="text"name="unit[]" id="unit'+counter+'" class="inputbxs4" placeholder="Unit"/></td><td id="td4"><input type="text"name="cost[]" id="cost'+counter+'" class="inputbxs4" placeholder="Amount"/></td><td id="td4"><input type="text"name="Quantity[]" id="Quantity'+counter+'" class="inputbxs4" placeholder="Quantity"/></td><td id="td4"><input data-toggle="modal"  data-id="'+counter+'" type="text"name="height[]" id="height2'+counter+'" class="inputbxs4" placeholder="Height"/></td><td><input type="text"name="width[]" id="width2'+counter+'" data-toggle="modal"  data-id="'+counter+'" class="inputbxs4" placeholder="Width"/></td><td id="td4"><input type="text"name="lenght[]" id="lenght2'+counter+'" class="inputbxs4" placeholder="Depth"/></td><td id="td4"><input type="text"name="color[]"  data-toggle="modal"  data-id="'+counter+'" id="color2'+counter+'" class="inputbxs4" placeholder="Color"/></td><td id="td4"> <input name="frame_code[]" id="package_code_gen2'+counter+'" style="    width: 73px; height: 29px; margin-top: 17px;"> </td><td id="td4"><textarea name="desc[]" id="desc'+counter+'" rows="4" cols="15" placeholder="Description" style="margin-right: 23px;"></textarea></td></tr></table>');
...
'<table style="border-top: 0px; border-bottom: 0px; width:95%;"><tr><td id="td06"><input type="hidden" name="some_code[]" value="<?=$hard_code?>"><input type="text"name="framename[]" id="hardboard'+counter+'" class="inputbxs06" style="margin-left: 0px;" placeholder="Harb Borad"/></td><td id="td06"><input type="text"name="unit[]" id="unit'+counter+'" class="inputbxs06" placeholder="Unit"/></td> <td id="td06"><input type="text"name="cost[]" id="cost'+counter+'" class="inputbxs06" placeholder="Amount"/></td><td id="td06"><input type="text"name="Quantity[]" id="Quantity'+counter+'" class="inputbxs06" placeholder="Quantity"/></td><td id="td06"><input type="text"name="height[]" id="height5'+counter+'" data-toggle="modal"  data-id="'+counter+'" class="inputbxs06" placeholder="Height"/></td><td id="td06"><input type="text"name="width[]"  data-toggle="modal"  data-id="'+counter+'" id="width5'+counter+'" class="inputbxs06" placeholder="Width"/></td><td id="td06"><input type="text"name="lenght[]" id="lenght'+counter+'" class="inputbxs06" placeholder="Depth"/></td><td id="td06"><input type="text"name="color[]" data-toggle="modal"  data-id="'+counter+'"  id="color5'+counter+'" class="inputbxs06" placeholder="Color"/></td><td id="td06"><input name="frame_code[]" id="package_code_gen5'+counter+'" style="    width: 73px; height: 29px; margin-top: 17px;"></td><td id="td06"><textarea name="desc[]" id="desc'+counter+'" rows="4" cols="15" placeholder="Description" style="margin-right: 23px;"></textarea></td></tr></table>');
