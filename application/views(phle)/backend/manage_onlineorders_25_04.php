...
<div class="main-hdr"> View Quotations</div>
...
<option value="<?=$q_id->quotation_id?>"><?=$q_id->quotation_id?></option>
  ...
  <tr>
    ...
    <td><input name="from" type="date" id="from" style="width: 120px;" placeholder="from"   class="date-range">

-

<input name="to" type="date" id="to" placeholder="to" class="date-range" style="width: 120px;" onblur="search_by_date();"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
function newPopup(url) {
	popupWindow = window.open(
     ...
     $search_datacount=count($search_data);  if($quotation_count || $search_datacount) {
          ...
          <tr>
                  ...
                  <input type="hidden" name="invoice_id" value="<?php echo $print['quotation_id'];?>">
                         ...
                         <td> <a href="JavaScript:newPopup('<?=base_url()?>index.php/quotation/quotation_view/<?=$print['quotation_id'];?>');">View Quotation</a>
