        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="creat-ordertable">
            ...
            <tr>
                ...
                <input type="radio" name="qutatiion" id="add_offline" onClick="return change_form_status('2');" value="2">
                                  ...
                                  <tr  class="darktr" id="online_radio">
                                    <td></td>
                                    <td> Print&nbsp;
                                        <input type="radio" name="category"  data-id="1" onClick="return calculator_show('1');" data-anil="mohan" class="print_type"  checked=""  id="print" value="1" >
                &nbsp;Print+Mount&nbsp;
                <input type="radio" name="category" data-id="2" class="print_type"  onclick="return calculator_show('2');" id="print_mount"  value="2">
				&nbsp;Print+Mount+Glass&nbsp;
                <input type="radio" name="category" data-id="3" class="print_type" onClick="return calculator_show('3');"  id="print_mount_glass"  value="3">
			&nbsp;Print+frame+Mount+Glass&nbsp;
                <input type="radio" name="category" data-id="4" class="print_type" onClick="return calculator_show('4');" id="print_frame_mount_glass"  value="4">
                                  ...
                                  <tr  class="darktr" id="offline_radio">
                                    <td></td>
                                    	<td> Print&nbsp;
	<input type="radio"  name="category_off"  data-id="1" onClick="return calculator_offline('1');" data-anil="mohan" class="print_type"  checked=""  id="print_off" value="1" >
	Print+Mount&nbsp;
	<input type="radio" name="category_off" data-id="2" class="print_type"  onclick="return calculator_offline('2');" id="print_mount_off"  value="2">
	&nbsp;Print + frame&nbsp;
	<input type="radio"  name="category_off"  data-id="3" onClick="return calculator_offline('3');" data-anil="mohan" class="print_type"    id="print_frame_off" value="3" >
	&nbsp;
     Print+frame+Mount+Glass&nbsp;
	<input type="radio" name="category_off" data-id="4" class="print_type" onClick="return calculator_offline('4');" id="print_frame_mount_glass_off"  value="4">

	&nbsp;Print+frame+Mount&nbsp;
	<input type="radio" name="category_off" data-id="5" class="print_type"  onclick="return calculator_offline('5');" id="print_frame_mount_off"  value="5">
	&nbsp;Print+frame+Canvas&nbsp;
	<input type="radio" name="category_off" data-id="6" class="print_type" onClick="return calculator_offline('6');" id="print_frame_canvas_off"  value="6">
...
<span id="image_visual_offline" class="image_visual_offline" ></span></td>
                       <td><span id="license_cost_off0">0.00</span><br><input type="text" class="txtbox2" name="license_cost_off[]" onkeyup="return calculator_offline();" onBlur="return calculator_offline();" id="license_cost_off0"  class="txtbox2"/></td>
                        ...
                        <td class="cover"><input type="tex" readonly="" name="glass_cost_off" id="glass_cost_off0" class="txtbox2" ></td>
                                    ...
                                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                <tr>
                                        <td class="bold">Packaging Charges: (Rs.)</td>
                                        <td><input type="text" name="packaging_charge"  id="packaging_charge_off" value="" class="txtbox2" onKeyUp="return calculator_offline();" onBlur="return calculator_offline();">
                  </td>
                                      </tr>
                <tr class="darktr">
                                        <td class="bold">Courier Charges: (Rs.)</td>
                                        <td><input type="text" name="courier_charge"   id="courier_charge_off" value="<?='50'?>"  class="txtbox2" onKeyUp="return calculator_offline();" onBlur="return calculator_offline();"></td>
                                      </tr>
                <tr>
                                        <td class="bold">Discount:</td>
                                        <td><input type="text" name="discount_val"  id="discount_off" class="txtbox2"  onkeyup="return calculator_offline();" onBlur="return calculator_offline();"></td>
                                      </tr>
                <tr class="darktr">
                                        <td class="bold">Total Discount: (Rs.)</td>
                                        <td><input type="text" name="tax_amount" readonly="" value="" id="after_discount_off" class="txtbox2"></td>
                                      </tr>
                                      <tr class="vat">
                                                                <td class="bold">Tax - 5% VAT: </td>
                                                              ...
                                                              <tr class="cst">
                                                                    <td class="bold">CST - 5%: </td>
                                                                    <td><input type="text" readonly="" name="tax" value="" class="txtbox2"></td>
                                                              </tr>
                                        ...
                                        <tr class="Channel_p">
                                        <td class="bold">CP Amount: (Rs.)</td>
                                        <td><input type="text"  id="cp_amount" name="cp_amount" onKeyUp="return reverse_calculate();"  class="txtbox2"></td>
                                      </tr>
...
var finalTotal_txt_off_cp=$('#finalTotal_txt_off_cp').val();

var basic_final_amt=parseInt(finalTotal_txt_off_cp)*100/105;
var basic_cp_amt=parseInt(cp_amount)*100/105;
var cp_discount_amt=parseInt(basic_final_amt-basic_cp_amt);
var discount_percetage=parseInt(cp_discount_amt*100/basic_final_amt);
var discount_percetage_fix=discount_percetage.toFixed(2);
var cp_discount_amt_fix=cp_discount_amt.toFixed(2);
$('#discount_off').val(discount_percetage_fix+' %');
$('#after_discount_off').val(cp_discount_amt_fix);
}
