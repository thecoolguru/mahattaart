...
.manage-order .creat-ordertable tr td{ padding:8px 1px 8px 1px !important;} .hdrs td:nth-child(2) { width:100px;}
    ...
    <div id="quotationListDiv" class="manage-order" >
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="creat-ordertable">
		  ...
		  <tr  class="darktr">
            <td width="18%" class="bold">Customer Type:</td>
            
									 <td>
									 <select name="customer_type" id="customer_type"  onChange="get_customer_type_changes(this.value);" >
            ...
            <tr style="display:none" class="darktr cus_details">
            <td width="18%" class="bold">Customer Name:</td>
            <td>
            ...
            <tr  style="display:none" class="darktr cus_details">
            <td width="18%" class="bold">Customer City:</td>
            <td>
            ...
            <tr  style="display:none" class="darktr cus_details">
            <td width="18%" class="bold">Customer Phone:</td>
            <td>
            ...
            <tr style="display:none" class="darktr cus_details">
            <td width="18%" class="bold">Email Id:</td>
            <td>
                                     <input type="text" name="customer_email"  >
                                  </td>
          </tr>
		  <tr style="display:none" class="darktr cus_details">
            <td width="18%" class="bold">Address:</td>
            <td>
          ...
          <tr  class="darktr">
            ...
            <td><select name="customer_id" id="customer_id"  onchange="filter_customers(this.value)"  class="selectpicker" data-hide-disabled="true" data-live-search="true">
                ...
                <?php $customers=$this->backend_model->get_customers_company(); 
            ...
            <tr>
                  <td colspan="2" style="padding:0;"><div class="quotation-div"  id="quotation2Div" style="margin-left:0px" >
                      <!--DETAILS TABLE-->
                      <div style="background:#388fc4; font-size:16px; color:#fff; padding:8px; "> Company Details</div>
