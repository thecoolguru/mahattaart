...
.manage-order .creat-ordertable tr td{ padding:8px 1px 8px 1px !important;} .hdrs td:nth-child(2) { width:100px;}
    ...
    <div id="quotationListDiv" class="manage-order" >
          <form  name="create_quotation" action="save_inventry_item" method="post"  enctype="multipart/form-data">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="creat-ordertable">
            ...
            <td width="60%"><?php   //  $uniqueNo =mt_rand();    $uniqueNo=sprintf('%03d',$uniqueNo);    ECHO $QuotationN0='WNS'.$uniqueNo;        ?>
                  <input type="text" id="product_id"  required name="productid">
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="creat-ordertable">
  ...
  <tr class="darktr">
    ...
    <td><input type="text" required data-id="0" name="itemname" id=""   class="printer" >
    </td>
    <td class="bold">Roll Size (width):</td>
    <td><input type="text" data-id="0" name="rollsize"   class="printer">
    </td>
	 <td class="bold">Roll Qty:</td>
    <td><input type="tex" data-id="0" name="rollqty"     class="printer" ></td>
  ...
  <tr>
   <td class="bold">Height</td>
    <td class="printer">
      <input type="tex"  data-id="0" name="height"    class="print_cost_custom printer" ></td>
    <td class="bold">GSM </td>
    <td class="printer"><input type="tex" data-id="0"  name="gsmname"  class="printer" ></td>
...
<!--
		...
		<div style="padding:30px; text-align:left">
              <input type="submit" name="addcpn" id="addcpn" value="	Submit Inventory Item" class="btn btn-success pull-right" >
            </div>
      </form>
        </div>
  </div>
