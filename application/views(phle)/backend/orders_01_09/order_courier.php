...
function change_services(values) {     if(values=='material')     {      $('#default_printer').show();      $('#printer').hide();        }else if(values=='services')     {      $('#default_printer').hide();      $('#printer').show();        } }function update_courier_details()        {                
            ...
            <td colspan="2" ><div class="viewcplist-inner">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    $alloweted_date=$date[0].'-'.$date[1].'-'.$time.' '.$db_split[1];                             $system_date=date('Y-m-d h:t');                            $time_allow= strtotime($alloweted_date);                            $time_system= strtotime($system_date);                            $to='courier@wallsnart.com';                             if($time_allow<=$time_system && $status_framer==0)                             {                               $this->backend_model->sendmail('Courier',$to);                               }                                                 ?></td>
                  </tr>
                  <? $i++; }?>
                </table>
                <table style="width:100%">
                  ...
                  <tr>
					...
					<td><?=$result->rts_date;?></td>
                    <td><? if($result->dispatch_date=='0000-00-00 00:00:00'){ echo 'N/A';}else{ echo $result->dispatch_date;}?></td>
              ...
              <td colspan="2" style="padding:0;"><div class="quotation-div"  id="quotation2Div" style="margin-left:25px">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="darktr">
                      ...
                      <td width="250"><input  <?php if($printer[0]->courier_company_name<>''){ echo 'readonly';}?>type="text"  value="<?=$printer[0]->courier_company_name?>" name="company" id="company2" class="txtClass offline">
                    ...
                    <tr >
                      <td class="bold">Tracking Id</td>
                      <td ><input <?php if($printer[0]->tracking_id<>''){ echo 'readonly';}?> value="<?=$printer[0]->tracking_id?>" type="text" class="txtClass"  name="tracking_id" id="tracking_id"></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr class="darktr">
                    ...
                    <tr >
                      ...
                      <td><input type="date" name="ship_date"  id="ship_date" /></td>
                    </tr>
                    ...
                    <tr class="darktr">
                      ...
                      <td class="bold">Completion Date</td>
                      <td><input <?php if($printer[0]->completion_date<>''){ echo 'readonly';}?> <?php if($printer[0]->completion_date==''){?> type="date"<?php }else{?> type="text"<? }?> value="<?=$printer[0]->completion_date?>"  name="completion_date"  ></td>
                    </tr>
                    <tr class="darktr">
                      <td class="bold">QC</td>
