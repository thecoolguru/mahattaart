...
<div id="middle-wrapper">
  <div id="middle-container">
      ...
      <form action="<?=base_url()?>index.php/backend/add_printer_details" id="add_printer_form" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td><input type="radio" name="typesofvender" onclick="return services_vaalidate('services');" id="typesofvender" value="1" >
              Services
              </input>
              <br/>
              <input type="radio" name="typesofvender" onclick="return services_vaalidate('material');" id="typesofvender1" checked value="2">
              Row Material
              </input></td>
          </tr>
          <tr>
   ...
   <tr>
    ...
    <td><input type="text"name="cost[]" id="cost1" class="inputbxs1" placeholder="Rate"/></td>
    ...
    <td class="qty"><input type="text" name="qty[]" id="qty" class="inputbxs1"  placeholder="Quantity"> </td>
...
$('#list_display_name').hide();
 $('#new_display_name').show();
  ...
  var newTextBoxDiv = $(document.createElement('div'))
    ...
    newTextBoxDiv.after().html(
'<table style="border-top: 0px; border-bottom: 0px; width:100%;"><tr><td id="td11"> <input type="hidden" name="product_code[]" id="product_code_geno'+counter+'" ><input type="hidden" name="printer_code[]" value="<?=$printer_code?>"><input type="text"name="surface[]"  data-toggle="modal" data-id="'+counter+'" id="othername'+counter+'" class="inputbxs11" style="margin-left: 17px;" placeholder="Other Name"/></td> <td id="td11"><input type="text"name="cost[]" id="cost'+counter+'" class="inputbxs11" placeholder="Amount"/></td><td id="td11"><input type="text"name="qty[]" id="rate'+counter+'" class="inputbxs11" placeholder="Quantity"/></td><td id="td11"><input type="text"name="unit[]" id="unit'+counter+'" class="inputbxs11" placeholder="Unit"/></td></tr></table>');
