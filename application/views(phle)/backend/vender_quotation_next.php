...
$(document).ready(function(){
    ...
    $("#addButton").click(function () {
        ...
        if(counter>20){    alert("Only 20 textboxes allow");            return false;	}   			var newTextBoxDiv = $(document.createElement('div'))	     .attr("id", 'TextBoxDiv' + counter);
...
$(document).ready(function(){
 var counter = 1;
	...
	//var lol = document.getElementById('order_id_custom');
...
<div id="middle-wrapper">
    ...
    <div class="main-hdr-quotation"> Create Vendor Quotations</div>
    <style>
.manage-order .creat-ordertable tr td{ padding:8px 1px 8px 1px !important;} .hdrs td:nth-child(2) { width:100px;}
    ...
    <div id="quotationListDiv" class="manage-order" >
          <form  name="create__vendor_quotation" action="<?=base_url()?>index.php/backend/save_vendor_create_quotation" method="post"  enctype="multipart/form-data">
        ...
        <b  style=" font-size: 14px; color: green;">
            ...
            function outtime(){                  window.location.href="view_vendor_quotations/";              }           </script>
            <?php echo $msg;}?></b><br>
        <br>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="creat-ordertable">
  <tr >
    <td><span> Print Type </span> &nbsp;
        ...
        <option value="6">Print+Canvas</option>
      </select></td>
  ...
  <tr class="darktr">
   <td class="bold">SKU ID</td>
    <td><input type="tex"  class="txtbox2" name="sku_id[]"   id="sku_id0">
  ...
  <td class="bold order_id0">Order Id</td>
    <td class="order_id0"><input type="text" name="order_id_custom[]" value="<?=$order_id;?>" readonly class="txtbox2" id="order_id_custom0"></td>
  </tr>
  <tr bgcolor="#388fc4">
  ...
  <tr class="frame0">
    <td class="bold frame0"><span class="bold mount"></span>Actual  Rate:</td>
    ...
    <td class="bold frame0">Actual Frame Cost </td>
  ...
  <tr class="canvas0">
    ...
    <td class="bold canvas0">Desired Canvas Cost </td>
  ...
  <tr class="canvas0">
    ...
    <td class="bold canvas0"><span class="bold ">Actual Rate</span> </td>
  ...
  <tr class="cover0">
    ...
    <td class="bold cover0">Desired Glass Cost </td>
  ...
  <tr class="cover0">
    ...
    <td class="bold cover0"><span class="bold mount"></span>Actual Rate</td>
...
-->
                                      ...
                                      <td class="bold">Total CP Amount: (Rs.)</td>
                                        ...
                                        <td class="total-price"><div >
                                            <input type="hidden" readonly=""  style="background-color:#08558d; font: bold; border: none;" name="finalTotal_txt1" id="Total_txt_amount_custom" value="">
...
<script>
function get_customer_type_changes(values){
if(values=='B2CP'){
$('.cus_details').show();
}
if(values=='B2B' || values=='B2C'){
$('.cus_details').hide();
}
 ...
 $('.mount_cost_custom').keyup(function(){
  ...
  var category_custom=  $('#category_custom'+id).val();
   ...
   var print_height_custom=$('#print_height_custom'+id).val();
    ...
    var canvas_cost=parseFloat(canvas_val*70/12);
