...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="toptr">
    ...
    <td><input type="text" name="contactname" id="contactname" class="inputbxs" /></td>
    </tr>
    
 <tr class="toptr">
    <td width="280">Company Name*</td>
    <td><input type="text" name="name" id="name" class="inputbxs" /></td>
    </tr>
 ...
 <tr class="toptr">
  ...
  <tr class="toptr">
   ...
   <tr class="toptr">
    <td width="280">Email id</td>
    <td><input type="text" name="email" id="email" class="inputbxs" /></td>
    </tr>

<tr class="toptr">
    <td width="280">Mobile Number</td>
    <td><input type="text" name="mobile" id="mobile" class="inputbxs" /></td>
    </tr>
<tr class="toptr">
...
<tr class="toptr">
    ...
    <td><input type="text" name="pin" id="pin" class="inputbxs" /></td>
    </tr>
...
<tr class="toptr">
    ...
    <td><input type="text" namship_charge" id="ship_charge" class="inputbxs" /></td>
    </tr>
...
<tr class="toptr">
    ...
    <td><input type="radio" name="del_to_office" id="del_to_office" value="1" checked>Yes</input><br/><input type="radio" name="del_office" id="del_office" value="0">No</input></td>
    </tr>
...
<tr class="toptr">
    ...
    <td><input type="file" name="file1" id="file1" class="inputbxs" /></td>
    </tr>
