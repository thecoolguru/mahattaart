...
<p>&nbsp;</p>
    ...
    <table style="width:100%">
              <tr><td class="bold">Order Id </td><td class="bold"> Company Name</td><td class="bold">Surface</td><td class="bold"> Print Size</td><td class="bold"> No of Print</td><td class="bold">  Deliver Date </td><td class="bold"> Completion Date </td><td class="bold">  Quality Check Status </td><td class="bold"> Quality Checker Name </td><td class="bold"> Person Incharge</td></tr>
            <?php
...
var val=$(this).data('id');
  ...
  <option value="">---Select Printers---</option>
                    ...
                    <tr >
                        ...
                        <td width="250">
<input  type="text" name="surface"  class="txtClass offline" value="<?=$printer[0]->surface?>">
...
<?php $size= split('x',$printer[0]->print_size);?>
                        <td >Height&nbsp;<input type="text" value="<?=$size[0];?>"  name="height" id="height" class="txtClass"></td>

                        <td>Width&nbsp; <input type="text" value="<?=$size[1];?>"  name="width" id="width" class="txtClass"></td>
                        ...
                        <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<?=$printer[0]->total_print?>" class="txtClass"  name="total_print" id="total_print"></td>
                    ...
                    <tr>
                        ...
                        <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<?=$printer[0]->quality_checker_name?>" name="name" id="name" class="txtClass" </td>
