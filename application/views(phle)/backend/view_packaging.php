...
<a href="<?=base_url()?>index.php/backend/add_packaging" class="addnewcp">Add New Packaging</a>
<a href="#" data-toggle="modal" data-target="#myModal" class="sendmail" data-mail="courier" data-id="<?=$print['order_id'];?>" >/ Send Mail</a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <br>
             <span style="font-size: 14px; float: left;">If you forget then please insert your registered email Id
            </span><br>
    ...
    alert(mail_id);
       var order_id= $('#send_order_id').val();
        if($('#mail_id').val()=='')
        {
         ...
         $.ajax({
            type:"post",
           url:"<?=base_url()?>index.php/backend/sendmailsure",
