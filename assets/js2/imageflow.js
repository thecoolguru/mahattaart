...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        1.4,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		buttons:            true,          /* Toggle navigation buttons */
		captions:           true,           /* Toggle captions */
		circular:           false,          /* Toggle circular rotation */
		imageCursor:        'default',      /* Cursor type for all images - default is 'default' */
		ImageFlowID:        'imageflow',    /* Default id of the ImageFlow container */
		imageFocusM:        1.4,            /* Multiplicator for the focussed image size in percent */
		imageFocusMax:      8,              /* Max number of images on each side of the focussed one */
		imagePath:          '',             /* Path to the images relative to the reflect_.php script */
		imageScaling:       true,           /* Toggle image scaling */ 
		imagesHeight:       0.55,           /* Height of the images div container in percent */
		...
		scrollbarP:         0.4,            /* Width of the scrollbar in percent */
