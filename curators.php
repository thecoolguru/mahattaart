...
<div  class="inner-main-container">
        ...
        <div class="pagination">
        	<span> <a href="<?=base_url()?>index.php/frontend/index">HOME</a> > <span> Curators </span> </span>
        </div>
    ...
    <li><a title="Share by youtube" rel="nofollow" href="#" class="social youtube">fab device</a></li>
        ...
        <h2><a onclick="dropdown()" href="#">View All Images </a></h2>
        
        <ul class="scroller"> 

		<li>
			<a href="http://www.indiapicture.in/wallsnart/398/UNRM_003734.JPG"> 
				<img src="http://www.indiapicture.in/wallsnart/398/UNRM_003734.JPG"> 
			</a>
		</li>

		<li> 
			<a href="http://dev.wallsnart.com/assets/img/art-h-img1.jpg"> 
...
<div style="margin:2% 27%; position:relative;">



<div id="close" onclick ="div_hide()" style="z-index:99;">  <i class="jq-overlay-close fa fa-times-circle"></i> </div>
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/004.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>img/thumb-004.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/005.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>application/views/frontend/img/thumb-005.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/006.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>application/views/frontend/img/thumb-006.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/007.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>application/views/frontend/img/thumb-007.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/008.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>application/views/frontend/img/008.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/009.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>img/009.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="application/views/frontend/img/010.jpg" />
                <img data-u="thumb" src="application/views/frontend/img/010.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="<?php print base_url();?>application/views/frontend/img/011.jpg" />
                <img data-u="thumb" src="<?php print base_url();?>application/views/frontend/img/thumb-011.jpg" />
            </div>
        </div>
        <!-- Thumbnail Navigator -->
